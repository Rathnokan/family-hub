...
`});var Mt,Ia=N(()=>{$a();Ea();za();Ma();Fa();Da();Mt=_a+Sa+Ca+Aa+Ba+Ra});var Ta=N(()=>{Ia()});var Pa,lt,H,Bt,ie,W,Ft,K=N(()=>{Pa="family_hub",lt="0.7.6",H="#7F77DD",Bt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],ie={task_completed:{label:"Completed",color:"var(--fh-success)"},task_approved:{label:"Approved",color:"var(--fh-success)"},pending_approval:{label:"Pending approval",color:"var(--fh-warning)"},task_denied:{label:"Denied",color:"var(--fh-overdue)"},task_skipped:{label:"Skipped",color:"var(--fh-warning)"},task_excused:{label:"Excused",color:"var(--fh-accent)"},task_rejected:{label:"Rejected",color:"var(--fh-overdue)"},task_marked_complete:{label:"Marked done",color:"var(--fh-success)"},task_late_claimed:{label:"Claimed late",color:"var(--fh-warning)"},points_awarded:{label:"Points",color:"var(--fh-accent)"},redemption_requested:{label:"Redeem request",color:"var(--fh-warning)"},redemption_approved:{label:"Redeem approved",color:"var(--fh-success)"},redemption_declined:{label:"Redeem declined",color:"var(--fh-overdue)"},task_added:{label:"Task added",color:"var(--fh-text-sec)"},person_added:{label:"Person added",color:"var(--fh-text-sec)"},allowance:{label:"Allowance",color:"var(--fh-success)"},completion_streak_milestone:{label:"Success streak",color:"var(--fh-success)"},weekly_completion_streak_milestone:{label:"Weekly streak",color:"var(--fh-success)"},subscription_cancel_declined:{label:"Cancel declined",color:"var(--fh-warning)"},subscription_updated:{label:"Sub updated",color:"var(--fh-text-sec)"},subscription_started:{label:"Subscribed",color:"var(--fh-accent)"},subscription_renewed:{label:"Sub renewal",color:"var(--fh-text-sec)"},subscription_lapsed:{label:"Sub lapsed",color:"var(--fh-warning)"},subscription_canceled:{label:"Sub canceled",color:"var(--fh-text-sec)"},subscription_cancel_requested:{label:"Cancel requested",color:"var(--fh-warning)"},group_proposed:{label:"Group proposed",color:"var(--fh-text-sec)"},group_chip_in:{label:"Chipped in",color:"var(--fh-accent)"},group_redeemed:{label:"Group redeemed",color:"var(--fh-success)"}},W={check:'<svg viewBox="0 0 24 24"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>',plus:'<svg viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"/></svg>',edit:'<svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zm17.71-10.21a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>',trash:'<svg viewBox="0 0 24 24"><path d="M6 19c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg>',bell:'<svg viewBox="0 0 24 24"><path d="M12 22a2 2 0 0 0 2-2h-4a2 2 0 0 0 2 2zm6-6V11a6 6 0 0 0-5-5.92V4a1 1 0 1 0-2 0v1.08A6 6 0 0 0 6 11v5l-2 2v1h16v-1l-2-2z"/></svg>',award:'<svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>',minus:'<svg viewBox="0 0 24 24"><path d="M19 13H5v-2h14z"/></svg>',close:'<svg viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>',settings:'<svg viewBox="0 0 24 24"><path d="M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58a.49.49 0 0 0 .12-.61l-1.92-3.32a.49.49 0 0 0-.59-.22l-2.39.96a7 7 0 0 0-1.62-.94l-.36-2.54a.484.484 0 0 0-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58a.49.49 0 0 0-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61l-2.01-1.58zM12 15.6a3.6 3.6 0 1 1 0-7.2 3.6 3.6 0 0 1 0 7.2z"/></svg>',person:'<svg viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>',store:'<svg viewBox="0 0 24 24"><path d="M20 4H4v2l16-2zm1 5H3l1 11h16l1-11zm-9 8H10v-4h2v4zm0-6H10v-2h2v2z"/></svg>',remove:'<svg viewBox="0 0 24 24"><path d="M15 16h4v2h-4zm0-8h7v2h-7zm0 4h6v2h-6zM2 6v14c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V6H2zm8 13H4v-1h6v1zm0-3H4v-1h6v1zm0-3H4v-1h6v1zm1-7H3V8h8V6zm-2-3H5V2h4v1z"/></svg>',history:'<svg viewBox="0 0 24 24"><path d="M13 3a9 9 0 0 0-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42A8.954 8.954 0 0 0 13 21a9 9 0 0 0 0-18zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>',excuse:'<svg viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/></svg>',print:'<svg viewBox="0 0 24 24"><path d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm-1-9H6v4h12V3z"/></svg>',rewards:'<svg viewBox="0 0 24 24"><path d="M20 6h-2.18c.07-.44.18-.88.18-1.36C18 2.53 15.89.36 13.36.36c-1.38 0-2.56.6-3.36 1.55C9.2.96 8.02.36 6.64.36 4.11.36 2 2.53 2 4.64c0 .48.11.92.18 1.36H0v4h1v10h22V10h1V6h-4zm-8 12H6V10h6v8zm0-10H4V8h8v2zm4 10h-2v-8h2v8zm2-10h-6V8h6v2zm-5.36-4c-.45 0-1.09-.49-1.09-1.36 0-.87.64-1.36 1.09-1.36.46 0 1.1.49 1.1 1.36C13.74 3.51 13.1 4 12.64 4zM6.64 4c-.45 0-1.09-.49-1.09-1.36 0-.87.64-1.36 1.09-1.36.46 0 1.1.49 1.1 1.36C7.74 3.51 7.1 4 6.64 4z"/></svg>',toggle:'<svg viewBox="0 0 24 24"><path d="M17 7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h10c2.76 0 5-2.24 5-5s-2.24-5-5-5zm0 8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/></svg>'},Ft=[{key:"brush-teeth-am",name:"Brush teeth",description:"Morning \u2014 brush for 2 minutes",category:"Morning",points:5},{key:"make-bed",name:"Make bed",description:"Pull up covers and fluff pillow",category:"Morning",points:10},{key:"get-dressed",name:"Get dressed",description:"Clothes on, shoes tied, ready to go",category:"Morning",points:5},{key:"take-vitamins",name:"Take vitamins",description:"",category:"Morning",points:5},{key:"eat-breakfast",name:"Eat breakfast",description:"",category:"Morning",points:5},{key:"brush-teeth-pm",name:"Brush teeth (evening)",description:"Before bed \u2014 brush for 2 minutes",category:"Evening",points:5},{key:"pajamas-on",name:"Pajamas on",description:"",category:"Evening",points:5},{key:"pick-up-room",name:"Pick up room",description:"Put toys away and tidy floor",category:"Evening",points:10},{key:"pack-backpack",name:"Pack backpack",description:"Ready for tomorrow",category:"Evening",points:10},{key:"clear-table",name:"Clear table",description:"After dinner \u2014 dishes to the sink",category:"Kitchen",points:10},{key:"load-dishwasher",name:"Load dishwasher",description:"",category:"Kitchen",points:15},{key:"unload-dishwasher",name:"Unload dishwasher",description:"",category:"Kitchen",points:15},{key:"wipe-counters",name:"Wipe counters",description:"",category:"Kitchen",points:10},{key:"take-out-trash",name:"Take out trash",description:"",category:"Chores",points:15},{key:"vacuum",name:"Vacuum living room",description:"",category:"Chores",points:20},{key:"sweep-floor",name:"Sweep/mop floor",description:"",category:"Chores",points:15},{key:"feed-pets",name:"Feed pets",description:"",category:"Chores",points:10},{key:"water-plants",name:"Water plants",description:"",category:"Chores",points:10},{key:"homework",name:"Homework",description:"Complete all assigned homework",category:"School",points:20},{key:"reading",name:"Reading time",description:"Read for 20 minutes",category:"School",points:15}]});function Oa(e){return e<-1?`${Math.abs(e)}d overdue`:e===-1?"1d overdue":e===0?"Today":e===1?"Tomorrow":`In ${e}d`}function dt(e,t){return e.map(a=>`<option value="${a.value}" ${a.value===t?"selected":""}>${a.label}</option>`).join("")}function ta(e,t,a=!1){let o=e||[],s=a?o.slice(0,1):o;return Bt.map((i,n)=>{let r=s.includes(n);return`<label class="fh-wd-chip ${r?"checked":""}">
        ...
        </div>`}function Ee(e){return Ga("daily",(e==null?void 0:e.daily_earned)||0,(e==null?void 0:e.daily_possible)||0,"today")}function Ce(e){return Ga("weekly",(e==null?void 0:e.week_earned)||0,(e==null?void 0:e.week_possible)||0,"this week")}function Ne(e,t){let a=e.filter(d=>d._over),o=e.filter(d=>!d._over),s=[];a.length&&s.push({label:"Overdue",tasks:a,isOverdue:!0});let i=t&&t.length?t:[...new Set(o.map(d=>d.category_label||""))],n=new Set(i);for(let d of i){let p=o.filter(c=>(c.category_label||"")===d);p.length&&s.push({label:d||"Other",tasks:p,isOverdue:!1})}let r=o.filter(d=>!n.has(d.category_label||""));return r.length&&s.push({label:"Other",tasks:r,isOverdue:!1}),s}function yo(e){if(!e)return"";let t=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],a=new Date;a.setHours(0,0,0,0);let o=e.recurrence_type,s=Number(e.days_until_reset);if(o&&o!=="one_time"&&o!=="daily"&&Number.isFinite(s)&&s>0){let r=new Date(a);return r.setDate(r.getDate()+s),s===1?"Tomorrow":s<=6?t[r.getDay()]:s===7?`Next ${t[r.getDay()].slice(0,3)}`:`${r.getMonth()+1}/${r.getDate()}`}if(!e.due_date)return"";let i=new Date(e.due_date+"T00:00:00");if(isNaN(i.getTime()))return"";let n=Math.round((i-a)/864e5);return n<0?"":n===0?"Today":n===1?"Tomorrow":n<=6?t[i.getDay()]:`${i.getMonth()+1}/${i.getDate()}`}function Y(e,t,a,o,s={}){let i=s.index,n=!!(o&&o._pendingSubmit&&o._pendingSubmit.has(e.task_id))||e.status==="pending_approval",r=!!e._over||!!e._overdue,d=e.chore_type==="reminder",p=e.streak||0,c=e.points||0,b=t.leadFormat&&!d?t.leadFormat(e,i):null,g=b!=null&&b!==""?`<div class="fh-row-lead">${f(String(b))}</div>`:"",u=t.kickerFormat&&!d?t.kickerFormat(e,i):null,x=u!=null&&u!==""?`<div class="fh-row-kicker">${f(String(u))}</div>`:"",$=t.iconColor?t.iconColor(e,r):void 0,h=`<div class="fh-row-icon">${pe(e.icon,$)}</div>`,_=e.description?`<div class="fh-row-desc">${f(e.description)}</div>`:"",S=!d&&e.penalty_enabled&&e.penalty_points>0,v=S&&!c?`<div class="fh-row-penalty">\u2212${e.penalty_points}pts if skipped</div>`:"",m=[];if(p>=2&&!d){let k=t.streakIcon||"\u{1F525}";m.push(`<span class="fh-row-chip fh-row-chip--streak">${k} ${p}</span>`)}if(r){let k=t.statusFormat&&t.statusFormat.breach?t.statusFormat.breach(e):`BREACH \xB7 ${e.days_overdue||0}D`;m.push(`<span class="fh-row-chip fh-row-chip--breach">${f(k)}</span>`)}else if(!d&&e.days_until_reset===1){let k=t.statusFormat&&t.statusFormat.resetSoon?t.statusFormat.resetSoon(e):"RESETS 1D";m.push(`<span class="fh-row-chip fh-row-chip--reset">${f(k)}</span>`)}if(!d&&e.daily_penalty_firing){let k=t.statusFormat&&t.statusFormat.firing?t.statusFormat.firing(e):`\u2212${e.penalty_points||0}pts/day`;m.push(`<span class="fh-row-chip fh-row-chip--firing">${f(k)}</span>`)}if(!d&&e.expires_after_days&&e.due_date){let k=new Date(e.due_date);k.setDate(k.getDate()+e.expires_after_days);let M=new Date;M.setHours(0,0,0,0),k.setHours(0,0,0,0);let A=Math.round((k-M)/864e5);if(A<=2){let B=t.statusFormat&&t.statusFormat.expiry?t.statusFormat.expiry(A):A<=0?"Expires today":`Expires in ${A}d`;m.push(`<span class="fh-row-chip fh-row-chip--expiry">${f(B)}</span>`)}}let w=`<div class="fh-row-chips">${m.join("")}</div>`,C="fh-row-pts",E="";d?E="":c&&S?(C+=" fh-row-pts--dual",E=`<span class="fh-row-pts-pos">+${c}</span><span class="fh-row-pts-sep">/</span><span class="fh-row-pts-neg">\u2212${e.penalty_points}</span>`):c?E=`+${c}`:S&&(E=`<span class="fh-row-pts-neg">\u2212${e.penalty_points}</span>`);let F=!d&&!n?yo(e):"",D=F?`<div class="fh-row-due">${f(F)}</div>`:"",R=`<div class="fh-row-pts-col"><div class="${C}">${E}</div>${D}</div>`,T=s.btnData?Object.entries(s.btnData).map(([k,M])=>` data-${k}="${z(String(M??""))}"`).join(""):"",P;if(n){let k=t.btnPendingLabel||"Pending<br>Approval";P=`<div class="fh-row-btn fh-row-btn--pending" aria-disabled="true">${t.btnPendingIcon?`<span class="fh-row-btn-icon">${t.btnPendingIcon}</span>`:""}<span class="fh-row-btn-label">${k}</span></div>`}else if(d){let k=t.reminderBtnLabel||"Dismiss";P=`<button class="fh-row-btn fh-row-btn--reminder"
                           data-act="complete" data-tid="${z(e.task_id)}" data-pid="${z(a.person_id)}"${T}>
        ...
        </div>`}function Ae(e){let t=(e==null?void 0:e.max_per_period)||0;if(!t)return"";let a=(e==null?void 0:e.period)||"week",s=`${t} per ${a==="day"?"day":a==="week"?"week":"month"}`,i=e==null?void 0:e.next_available;if(!i)return`<span class="fh-store-limit">${f(s)}</span>`;let n=new Date(i+"T00:00:00"),r=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"][n.getDay()],d=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"][n.getMonth()],p=`${r} ${d} ${n.getDate()}`;return`<span class="fh-store-limit fh-store-limit--blocked">${f(s)} \xB7 Available ${f(p)}</span>`}function Me(e,t,a){let o=(t==null?void 0:t.goal_item_id)&&t.goal_item_id===e.item_id;return`
        <button class="fh-goal-tog ${o?"is-goal":""}"
            ...
            <span class="fh-gcp ${d?"fh-gcp--me":""} ${p?"fh-gcp--done":""}"
                  title="${z(r.person_name||"?")} \u2014 ${r.contributed_pts}/${r.target_pts} pts${d?" (you)":""}">
        ...
        <button class="fh-group-chip-btn ${i?"":"fh-group-chip-btn--disabled"}"
            ...
            \u{1F91D} Chip In (${s} left)
        </button>`}function Re(e){if(!(e!=null&&e.locked))return"";let t=e.lock_reason||"Locked";return`<span class="fh-reward-lock" title="${z(t)}"
                  style="display:inline-flex;align-items:center;gap:4px;text-align:center;
                         ...
                         color:var(--fh-overdue);max-width:140px">\u{1F512} ${f(t)}</span>`}function De(e,t,a={}){if(!e||!e.length)return"";let o=!!a.bare,s=e.map(n=>{let r=n.claimable_subtype==="multi_claim",d=r?Math.max(0,n.slots_remaining??0):1;if(r&&d<=0)return"";let p=r?`${d} spot${d===1?"":"s"} left`:"first come";return`
      ...
      <div class="fh-bonus-board" style="margin-top:14px">
        ...
        ${s}
      </div>`}function Ie(e,t,a){let o=(e||[]).filter(n=>n.status!=="canceled");if(!o.length)return"";let s={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"};return o.map(n=>{let r=n.status==="lapsed",d=n.status==="cancel_pending",p=s[n.period]||n.period,c=n.points_cost+(n.accumulated_debt||0),b=Math.min(100,Math.round(t/Math.max(c,1)*100)),g=r?"#E85A5A":d?"#E0B84C":"currentColor",u;if(r)u=`Lapsed \xB7 owes ${n.accumulated_debt}pts`;else if(d)u="Cancellation pending approval";else{let h=n.days_until_renewal,_=h<=0?"Renews today":h===1?"Renews tomorrow":`Renews in ${h}d`,S=n.points_cost+(n.accumulated_debt||0);u=t>=S?`\u2713 Ready \xB7 ${_}`:`\u26A0 Need ${S-t}pts \xB7 ${_}`}let x=n.item_icon?`<span class="fh-sub-mini-icon">${pe(n.item_icon,null,"18px")}</span>`:"",$=d?"":`
            ...
            <div class="fh-sub-mini-row">
                ...
                ${$}
            </div>`}).join("")}function Te(e,t,a,o){let s={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"},i=new Set(["points_awarded","subscription_started","subscription_renewed"]),n={points_awarded:"Purchased",subscription_started:"Subscribed",subscription_renewed:"Sub renewal"},r=(e||[]).filter(b=>b.status!=="canceled"),d="";r.length&&(d=`<div class="fh-store-rail-section"><div class="fh-store-rail-hdr">YOUR SUBSCRIPTIONS</div>${r.map(g=>{let u=g.status==="lapsed",x=g.status==="cancel_pending",$=s[g.period]||g.period,h=g.points_cost+(g.accumulated_debt||0),_=Math.min(100,Math.round(t/Math.max(h,1)*100)),S=u?"#E85A5A":x?"#E0B84C":"currentColor",v;if(u)v=`Lapsed \xB7 owes ${g.accumulated_debt}pts`;else if(x)v="Cancellation pending approval";else{let C=g.days_until_renewal,E=C<=0?"Renews today":C===1?"Renews tomorrow":`Renews in ${C}d`,F=g.points_cost+(g.accumulated_debt||0);v=t>=F?`\u2713 Ready \xB7 ${E}`:`\u26A0 Need ${F-t}pts \xB7 ${E}`}let m=g.item_icon?`<span class="fh-sub-mini-icon">${pe(g.item_icon,null,"18px")}</span>`:"",w=x?"":`
                <button class="fh-sub-cancel-btn"
                        data-act="request-cancel-sub"
        ...
        <div class="fh-classic-rkpi-row">
            ...
            ${n("PENDING",i,"")}
        </div>`;return je("OVERVIEW",r)}function $o(e,t,a,o,s,i,n){let r=xe(e,t,a,o,Rt,s,i),d=we(i,s),p=ke(i),c=Se(n);return r?je("RANK",r+d+p+c):je("RANK",`<div class="fh-classic-rmax">${f(U(e,Rt).name)} \xB7 max</div>${d}${p}${c}`)}function So(e,t,a,o){let s=_e(e,t,a,8);if(!s.length)return je("STREAKS",'<div class="fh-classic-rempty">No active streaks yet</div>');let i=s.map(n=>{let{goalSegs:r,filledN:d,countLbl:p}=$e(n.streak,n.milestone,10),c=Array.from({length:r},(g,u)=>`<span class="fh-classic-rseg${u<d?" filled":""}" style="${u<d?`background:${o}`:""}"></span>`).join(""),b=n.milestone>0&&n.bonus>0?`<span class="fh-classic-rbonus">\u2605+${n.bonus}</span>`:"";return`
        ...
        <div class="fh-store-grid">
            ${i.map(g=>{let u=!!g.is_group_reward,x=g.item_type==="subscription",$=x&&b.has(g.item_id),h=o>=g.points_cost,_=p.has(g.item_id)||c.has(g.name),S=!!g.next_available,v={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[g.subscription_period]||"mo";return`
                <div class="fh-store-item">
                    ...
                    ${Ae(g)}
                    ${Be(g,a.person_id)}
                    ${u?Fe(g,a.person_id,o):g.locked&&!_&&!(x&&$)?Re(g):x?$?'<span class="fh-badge fh-badge-subscribed">Subscribed \u2713</span>':_?'<span class="fh-badge fh-badge-requested" style="text-align:center">Requested \u2713</span>':`<button class="fh-btn fh-btn-sm ${h?"fh-btn-primary":"fh-btn-ghost"}"
                                       style="${h?`background:${t}`:""}"
                                       data-act="redeem"
                                       data-iid="${z(g.item_id)}"
                                       data-pid="${z(a.person_id)}"
                                       ${h?"":"disabled"}>
                                   ${h?`Subscribe \xB7 ${g.points_cost}pts/${v}`:"Need more pts"}
                               </button>`:`<div class="fh-store-price" style="color:${t}">${O(g.points_cost)}pts</div>
                           ${_?'<span class="fh-badge fh-badge-requested" style="text-align:center">Requested \u2713</span>':S?'<button class="fh-btn fh-btn-sm fh-btn-ghost" disabled style="opacity:.5;cursor:not-allowed">Not available</button>':`<button class="fh-btn fh-btn-sm ${h?"fh-btn-primary":"fh-btn-ghost"}"
                                          style="${h?`background:${t}`:""}"
        ...
        </div>`}var Rt,Ua,qa=N(()=>{K();K();Q();et();Rt=[{minXP:0,name:"Level 1"},{minXP:100,name:"Level 2"},{minXP:300,name:"Level 3"},{minXP:700,name:"Level 4"},{minXP:1200,name:"Level 5"}],Ua={key:"classic",tint:"#1A2538",sigil:"\u25C7",ranks:Rt,handlesNavigation:!1,rankTitle(e){return U(e,Rt).name},homeTileSubLabel(e){return e.person_type==="parent"?"HANDLER":"FIELD AGENT"},render(e,t){var m;let a=t.child_mode?" kid-large":"",o=e._personEntityId(t.name),s=e._attrs(o),i=e._attrs("sensor.family_hub_needs_attention"),n=parseInt(((m=e._states(o))==null?void 0:m.state)||"0"),r=t.avatar_color||H,d=t.rank_index!==void 0?t.rank_index:0,{dropThr:p,gainThr:c}=ge(t,i,d),b=be(t.person_id,i.history_log,i.rank_eval_weekday),g=ue(t.person_id,i.history_log,i.rank_eval_weekday),u=ve(s),x=[{key:"tasks",label:"Tasks"},{key:"store",label:"Store"},{key:"history",label:"History"}].map(w=>`
            <div class="fh-tab ${e._tab===w.key?"active":""}"
                 data-act="tab" data-tab="${w.key}">${w.label}</div>`).join(""),$="";e._tab==="tasks"&&($=Co(s,r,t,e)),e._tab==="store"&&($=zo(s,r,t,n,e)),e._tab==="history"&&($=Ao(t,e));let h=(s.tasks_due_today_list||[]).filter(w=>w.status==="pending").length,_=(s.tasks_pending_approval_list||[]).length,S=e._tab==="tasks",v=S?wo({attr:s,naAttr:i,person:t,balance:n,weekly:b,lost:g,atRisk:u,openCount:h,pendingCount:_,rankIdx:d,dropThr:p,gainThr:c,color:r,card:e}):"";return`
        ...
        </div>`}function Lo(e,t,a,o){let s=e.tasks_due_today_list||[],i=e.tasks_overdue_list||[],n=e.tasks_pending_approval_list||[],r=o._attrs("sensor.family_hub_needs_attention").category_labels||[],d=(h,_)=>{let S=new Map;for(let v of h){let m=v.chore_id;(!S.has(m)||_(v,S.get(m)))&&S.set(m,v)}return[...S.values()]},p=d(i,(h,_)=>(h.days_overdue||0)>(_.days_overdue||0)),c=d(s.filter(h=>h.chore_type!=="reminder"),()=>!1),b=[...p.map(h=>({...h,_over:!0})),...c];if(!b.length&&!n.length)return'<div class="fh-eng-empty">&#10003; ALL WORK ORDERS COMPLETE &middot; AREA CLEAR</div>';let g=0,u=Ne(b,r).map(h=>{let _=`<div class="fh-row-section-hdr">// ${f(h.label.toUpperCase())}</div>`,S=h.tasks.map(v=>Y(v,Ja,t,o,{index:++g})).join("");return _+S}).join(""),x=0,$=n.length?`
        <div class="fh-row-section-hdr">// PENDING REVIEW</div>
        ${n.map(h=>Y(h,Ja,t,o,{index:++x})).join("")}`:"";return`
        ${Ee(e)}
        ${Ce(e)}
        ...
        <div class="fh-eng-reward-list">
            ${s.map(b=>{let g=!!b.is_group_reward,u=b.item_type==="subscription",x=u&&c.has(b.item_id),$=a>=b.points_cost,h=d.has(b.item_id)||p.has(b.name),_=!!b.next_available,S={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[b.subscription_period]||"mo";return`
                <div class="fh-eng-reward-row">
                    ...
                    ${Me(b,e,t.person_id)}
                    ${g?Fe(b,t.person_id,a):b.locked&&!h&&!(u&&x)?Re(b):u?x?`<div class="fh-eng-status" style="color:${ae.amber}">&#10003; SUBSCRIBED</div>`:h?`<div class="fh-eng-status" style="color:${ae.amber}">&#10003; REQUESTED</div>`:`<button class="fh-eng-stamp-btn ${$?"":"disabled"}"
                                       data-act="redeem"
                                       data-iid="${z(b.item_id)}"
                                       data-pid="${z(t.person_id)}"
                                       style="font-size:9px;${$?"":"opacity:.4;cursor:not-allowed"}">
                                   ${$?`SUBSCRIBE \xB7 ${b.points_cost}/${S}`:`INSUFFICIENT
FUNDS`}
                               </button>`:h?`<div class="fh-eng-status" style="color:${ae.amber}">&#10003; REQUESTED</div>`:_?`<div class="fh-eng-status" style="color:${ae.amber};font-size:.75rem">NOT AVAILABLE</div>`:`<button class="fh-eng-stamp-btn ${$?"":"disabled"}"
...
FUNDS`}
        ...
        ${a?e.items.map(s=>`
            ...
            <div class="fh-eng-page${a}">
                ...
                <div class="fh-eng-content">
                    ...
                    <div class="fh-eng-header">
                        ...
                        <div class="fh-eng-identity">
                            <div class="fh-eng-rank-line">
                                ${f(_.name.toUpperCase())} &middot; AGT ${f((t.code||t.name).toUpperCase())} &middot; DIV. ${f(t.person_type==="parent"?"PARENT":"FIELD")}
                            </div>
                    ...
                    <div class="fh-eng-body ${C?"has-rail":""}">
                        <div class="fh-eng-body-main">${h}</div>
                        ${C?`<aside class="fh-eng-rail">${E}</aside>`:""}
                    </div>

                    <!-- Footer \u2014 single mono status line -->
                    <div class="fh-eng-footer">
                        <span class="fh-eng-file-path">FILE &middot; /WORK_ORDERS/${m}.dwg &middot; LAST PLOT ${w} LOCAL &middot; SHEET A-101 R/A</span>
                    </div>
                </div>
        ...
        <div class="fh-bk-rkpi-row">
            ...
            </div>`}).join("");return Ge("today's tickets",o)}function Vo(e,t,a,o){let s=e.tasks_due_today_list||[],i=e.tasks_overdue_list||[],n=e.tasks_pending_approval_list||[],r=a.category_labels||[],d=(h,_)=>{let S=new Map;for(let v of h)(!S.has(v.chore_id)||_(v,S.get(v.chore_id)))&&S.set(v.chore_id,v);return[...S.values()]},p=d(i,(h,_)=>(h.days_overdue||0)>(_.days_overdue||0)),c=d(s.filter(h=>h.chore_type!=="reminder"),()=>!1),b=[...p.map(h=>({...h,_over:!0})),...c];if(!b.length&&!n.length)return`<div class="fh-bk-empty">\u2713 Kitchen's clear \u2014 all orders done!</div>`;let g=0,x=Ne(b,r).map(h=>{let _=`<div class="fh-row-section-hdr">${f(h.label)}</div>`,S=h.tasks.map(v=>Y(v,Ya,t,o,{index:++g})).join("");return _+S}).join(""),$=n.length?`
        <div class="fh-row-section-hdr">Awaiting approval</div>
        ${n.map(h=>Y(h,Ya,t,o)).join("")}`:"";return`
        ${Ee(e)}
        ${Ce(e)}
        <div class="fh-row-list">
            ${x}
        ...
        <div class="fh-bk-menu">
            ${s.map(c=>{let b=!!c.is_group_reward,g=c.item_type==="subscription",u=g&&p.has(c.item_id),x=a>=c.points_cost,$=r.has(c.item_id)||d.has(c.name),h=!!c.next_available,_={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[c.subscription_period]||"mo";return`
                <div class="fh-bk-menu-item">
                    ...
                    ${Me(c,e,t.person_id)}
                    ${b?Fe(c,t.person_id,a):c.locked&&!$&&!(g&&u)?Re(c):g?u?`<span class="fh-bk-badge" style="color:${se.terra}">Subscribed \u2713</span>`:$?`<span class="fh-bk-badge" style="color:${se.terra}">Requested \u2713</span>`:`<button class="fh-bk-go-btn ${x?"":"disabled"}"
                                       data-act="redeem"
                                       data-iid="${z(c.item_id)}"
                                       data-pid="${z(t.person_id)}"
                                       ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                                   ${x?`Subscribe \xB7 ${c.points_cost}pts/${_}`:"Need more"}
                               </button>`:$?`<span class="fh-bk-badge" style="color:${se.terra}">Requested \u2713</span>`:h?'<span class="fh-bk-badge" style="color:var(--fh-overdue)">Not available</span>':`<button class="fh-bk-go-btn ${x?"":"disabled"}"
                                   data-act="redeem" data-iid="${z(c.item_id)}" data-pid="${z(t.person_id)}"
                                   ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                               ${x?"Request":"Need more"}
                           </button>`}
                </div>`}).join("")}
        ...
        <div class="fh-dn-rkpi-row">
            ...
            <div class="fh-dn-rfind">
                <div class="fh-dn-rfind-tag">SP-${n} \xB7 FILED ${f(r.toUpperCase())}</div>
            ...
            </div>`}).join("");return We("RECENT FINDINGS",o)}function ni(e,t,a,o){let s=e.tasks_due_today_list||[],i=e.tasks_overdue_list||[],n=e.tasks_pending_approval_list||[],r=a.category_labels||[],d=(h,_)=>{let S=new Map;for(let v of h)(!S.has(v.chore_id)||_(v,S.get(v.chore_id)))&&S.set(v.chore_id,v);return[...S.values()]},p=d(i,(h,_)=>(h.days_overdue||0)>(_.days_overdue||0)),c=d(s.filter(h=>h.chore_type!=="reminder"),()=>!1),b=[...p.map(h=>({...h,_over:!0})),...c];if(!b.length&&!n.length)return'<div class="fh-dn-empty">\u25C9 SITE CLEAR \u2014 ALL SPECIMENS LOGGED</div>';let g=0,x=Ne(b,r).map(h=>{let _=`<div class="fh-row-section-hdr">${f(h.label)}</div>`,S=h.tasks.map(v=>Y(v,Za,t,o,{index:++g})).join("");return _+S}).join(""),$=n.length?`
        <div class="fh-row-section-hdr">AWAITING APPROVAL</div>
        ${n.map(h=>Y(h,Za,t,o)).join("")}`:"";return`
        ${Ee(e)}
        ${Ce(e)}
        <div class="fh-row-list">
            ${x}
        ...
        <div class="fh-dn-supply">
            ${s.map(c=>{let b=!!c.is_group_reward,g=c.item_type==="subscription",u=g&&p.has(c.item_id),x=a>=c.points_cost,$=r.has(c.item_id)||d.has(c.name),h=!!c.next_available,_={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[c.subscription_period]||"mo";return`
                <div class="fh-dn-supply-item">
                    ...
                    ${Me(c,e,t.person_id)}
                    ${b?Fe(c,t.person_id,a):c.locked&&!$&&!(g&&u)?Re(c):g?u?`<span style="color:${oe.amber};font-size:.8rem;font-weight:700">SUBSCRIBED \u2713</span>`:$?`<span style="color:${oe.amber};font-size:.8rem;font-weight:700">REQUESTED \u2713</span>`:`<button class="fh-dn-go-btn ${x?"":"disabled"}"
                                       data-act="redeem"
                                       data-iid="${z(c.item_id)}"
                                       data-pid="${z(t.person_id)}"
                                       ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                                   ${x?`SUBSCRIBE \xB7 ${c.points_cost}/${_}`:"NEED MORE"}
                               </button>`:$?`<span style="color:${oe.amber};font-size:.8rem;font-weight:700">CLAIMED \u2713</span>`:h?'<span style="color:var(--fh-overdue);font-size:.75rem;font-weight:600">NOT AVAILABLE</span>':`<button class="fh-dn-go-btn ${x?"":"disabled"}"
                                   data-act="redeem" data-iid="${z(c.item_id)}" data-pid="${z(t.person_id)}"
                                   ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                               ${x?"CLAIM":"NEED MORE"}
                           </button>`}
        ...
        <div class="fh-hp-rkpi-row">
            ...
            </div>`}).join("");return Ue("OWL POST",o)}function ui(e,t,a,o){let s=e.tasks_due_today_list||[],i=e.tasks_overdue_list||[],n=e.tasks_pending_approval_list||[],r=a.category_labels||[],d=(h,_)=>{let S=new Map;for(let v of h)(!S.has(v.chore_id)||_(v,S.get(v.chore_id)))&&S.set(v.chore_id,v);return[...S.values()]},p=d(i,(h,_)=>(h.days_overdue||0)>(_.days_overdue||0)),c=d(s.filter(h=>h.chore_type!=="reminder"),()=>!1),b=[...p.map(h=>({...h,_over:!0})),...c];if(!b.length&&!n.length)return'<div class="fh-hp-empty">All assignments complete \u2014 10 points to the house!</div>';let g=0,x=Ne(b,r).map(h=>{let _=`<div class="fh-row-section-hdr">${f(h.label)}</div>`,S=h.tasks.map(v=>Y(v,as,t,o,{index:++g})).join("");return _+S}).join(""),$=n.length?`
        <div class="fh-row-section-hdr">Awaiting approval</div>
        ${n.map(h=>Y(h,as,t,o)).join("")}`:"";return`
        ${Ee(e)}
        ${Ce(e)}
        <div class="fh-row-list">
            ${x}
        ...
        <div class="fh-hp-vault">
            ${s.map(c=>{let b=!!c.is_group_reward,g=c.item_type==="subscription",u=g&&p.has(c.item_id),x=a>=c.points_cost,$=r.has(c.item_id)||d.has(c.name),h=!!c.next_available,_={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[c.subscription_period]||"mo";return`
                <div class="fh-hp-vault-item">
                    ...
                    ${Me(c,e,t.person_id)}
                    ${b?Fe(c,t.person_id,a):c.locked&&!$&&!(g&&u)?Re(c):g?u?`<span style="color:${re.emerald};font-size:.8rem;font-weight:700">Subscribed \u2713</span>`:$?`<span style="color:${re.emerald};font-size:.8rem;font-weight:700">Requested \u2713</span>`:`<button class="fh-hp-cast-btn ${x?"":"disabled"}"
                                       data-act="redeem"
                                       data-iid="${z(c.item_id)}"
                                       data-pid="${z(t.person_id)}"
                                       ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                                   ${x?`Subscribe \xB7 ${c.points_cost}pts/${_}`:"Need more"}
                               </button>`:$?`<span style="color:${re.emerald};font-size:.8rem;font-weight:700">Requested \u2713</span>`:h?'<span style="color:var(--fh-overdue);font-size:.75rem;font-weight:600">Not available</span>':`<button class="fh-hp-cast-btn ${x?"":"disabled"}"
                                   data-act="redeem" data-iid="${z(c.item_id)}" data-pid="${z(t.person_id)}"
                                   ${x?"":'disabled style="opacity:.4;cursor:not-allowed"'}>
                               ${x?"Request":"Need more"}
                           </button>`}
        ...
        <div class="fh-dbz-next-bar-track"><div class="fh-dbz-next-bar-fill" style="width:${t}%"></div></div>`;return qe("NEXT POWER-UP",a)}function zi(e,t,a,o){let s=e.tasks_due_today_list||[],i=e.tasks_overdue_list||[],n=e.tasks_pending_approval_list||[],r=a.category_labels||[],d=($,h)=>{let _=new Map;for(let S of $)(!_.has(S.chore_id)||h(S,_.get(S.chore_id)))&&_.set(S.chore_id,S);return[..._.values()]},p=d(i,($,h)=>($.days_overdue||0)>(h.days_overdue||0)),c=d(s.filter($=>$.chore_type!=="reminder"),()=>!1),b=[...p.map($=>({...$,_over:!0})),...c];if(!b.length&&!n.length)return`
            <div class="fh-dbz-all-done">
                <div class="fh-dbz-all-done-icon">\u2B50</div>
                <div class="fh-dbz-all-done-text">ALL DONE!</div>
            </div>`;let u=Ne(b,r).map($=>{let h=`<div class="fh-row-section-hdr">${f($.label)}</div>`,_=$.tasks.map(S=>Y(S,is,t,o)).join("");return h+_}).join(""),x=n.length?`
        <div class="fh-row-section-hdr">WAITING FOR APPROVAL</div>
        ${n.map($=>Y($,is,t,o)).join("")}`:"";return`
        ${Ee(e)}
        ${Ce(e)}
        <div class="fh-row-list">
            ${u}
        ...
        <div class="fh-dbz-powerup-list">
            ${s.map(c=>{let b=!!c.is_group_reward,g=c.item_type==="subscription",u=g&&p.has(c.item_id),x=a>=c.points_cost,$=r.has(c.item_id)||d.has(c.name),h=!!c.next_available,_={weekly:"wk",monthly:"mo",quarterly:"qtr",biannual:"6mo",annual:"yr"}[c.subscription_period]||"mo";return`
                <div class="fh-dbz-powerup-row ${!b&&!g&&!x?"locked":""}">
                    ...
                    ${Me(c,e,t.person_id)}
                    ${b?Fe(c,t.person_id,a):c.locked&&!$&&!(g&&u)?Re(c):g?u?`<span style="color:${le.orange};font-weight:800;font-size:.9rem">SUB \u2713</span>`:$?`<span style="color:${le.orange};font-weight:800;font-size:.9rem">SENT \u2713</span>`:`<button class="fh-dbz-go-btn ${x?"":"locked"}"
                                       data-act="redeem"
                                       data-iid="${z(c.item_id)}"
                                       data-pid="${z(t.person_id)}"
                                       ${x?"":'disabled style="opacity:.35;cursor:not-allowed"'}>
                                   ${x?`SUB \xB7 ${c.points_cost}/${_}`:"NEED \u26A1"}
                               </button>`:$?`<span style="color:${le.orange};font-weight:800;font-size:.9rem">SENT \u2713</span>`:h?'<span style="color:var(--fh-overdue);font-weight:700;font-size:.8rem">NOT YET</span>':`<button class="fh-dbz-go-btn ${x?"":"locked"}"
                                   data-act="redeem" data-iid="${z(c.item_id)}" data-pid="${z(t.person_id)}"
                                   ${x?"":'disabled style="opacity:.35;cursor:not-allowed"'}>
                               ${x?"GET!":"NEED \u26A1"}
                           </button>`}
        ...
        ${a?e.items.map(s=>`
            <div class="fh-dbz-log-row" style="padding-left:20px;opacity:.75">
                ...
                ${fe(s)}
            </div>`).join(""):""}`}var le,is,kt,ns,rs=N(()=>{Q();K();et();le={sky:"#3FAAD9",orange:"#FF6A1A",yellow:"#FFE03A",navy:"#0F1E2E",white:"#FFFFFF",mute:"rgba(15,30,46,.6)",red:"#CC2200"},is={themeKey:"dbz",btnLabel:"GO!",btnPendingLabel:"PENDING",reminderBtnLabel:"OK",streakIcon:"\u26A1",statusFormat:{breach:e=>`!OVERDUE ${e.days_overdue}D`,resetSoon:()=>"RESETS 1D",firing:e=>`\u2212${e.penalty_points}\u26A1/D`,expiry:e=>e<=0?"EXPIRES TODAY":`EXPIRES ${e}D`},iconColor:(e,t)=>t?le.red:le.navy},kt=[{minXP:0,name:"Saibaman"},{minXP:100,name:"Saiyan"},{minXP:300,name:"Super Saiyan"},{minXP:700,name:"SSJ2"},{minXP:1200,name:"SSJ Blue"}],ns={key:"dbz",tint:"#3FAAD9",sigil:"\u25CE",ranks:kt,handlesNavigation:!1,rankTitle(e){return U(e,kt).name},homeTileSubLabel(){return"SAIYAN WARRIOR"},render(e,t){var F;let a=t.child_mode?" kid-large":"",o=e._personEntityId(t.name),s=e._attrs(o),i=e._attrs("sensor.family_hub_needs_attention"),n=parseInt(((F=e._states(o))==null?void 0:F.state)||"0"),r=t.rank_index!==void 0?t.rank_index:0,{dropThr:d,gainThr:p}=ge(t,i,r),c=be(t.person_id,i.history_log,i.rank_eval_weekday),b=ue(t.person_id,i.history_log,i.rank_eval_weekday),g=ve(s),u=U(r,kt),x=[{key:"tasks",label:"\u{1F4AA} TRAIN"},{key:"store",label:"\u{1F48E} SHOP"},{key:"history",label:"\u{1F3C6} WINS"}],$=e._tab||"tasks",h=x.map(D=>`
            <div class="fh-dbz-tab ${$===D.key?"active":""}"
                 data-act="tab" data-tab="${D.key}">${D.label}</div>`).join(""),_="";$==="tasks"&&(_=zi(s,t,i,e)),$==="store"&&(_=Ai(s,t,n,e)),$==="history"&&(_=Mi(t,e));let S=(s.tasks_due_today_list||[]).filter(D=>D.status==="pending").length,v=s.store_items||[],m=v.find(D=>D.points_cost>n)||v[0]||null,w=m?Math.min(100,Math.round(n/m.points_cost*100)):100,C=$==="tasks",E=C?ki({attr:s,naAttr:i,person:t,balance:n,weekly:c,lost:b,atRisk:g,openCount:S,rankIdx:r,dropThr:d,gainThr:p,nextItem:m,fillPct:w,card:e}):"";return`
            <div class="fh-dbz-page${a}">
                ...
                <div class="fh-dbz-body ${C?"has-rail":""}">
                    <div class="fh-dbz-body-main">${_}</div>
                    ${C?`<aside class="fh-dbz-rail">${E}</aside>`:""}
                </div>
        ...
        <div class="fh-mc">
            ...
            <div class="fh-mc-body">
                <main class="fh-mc-main">
                    ...
                    ${Ti(v,e)}
                    ${Pi(m,r,e)}
                    ${!v.length&&!m.length?`<div class="fh-mc-empty">
    ...
    `}function Ii(e,t,a,o){if(!e.length)return"";let s=e.map(i=>{var _;let n=i.avatar_color||H,r=o._filter===i.person_id,d=o._filter&&!r,p=t.filter(S=>S.assigned_to===i.person_id).length,c=a.filter(S=>S.person_id===i.person_id).length,b=(i.code||i.name||"AGT").toUpperCase(),g=parseInt(((_=o._states(o._personEntityId(i.name)))==null?void 0:_.state)||"0"),u=i.completion_milestone||0,x=i.completion_streak||0,$=i.completion_threshold_pct||80,h=u>0&&x>0?`<div class="fh-mc-agent-streak" title="${$}% of daily chores for ${x} days running">
                   \u{1F525} ${x}d \xB7 ${$}%
               </div>`:"";return`
            <button class="fh-mc-agent ${r?"active":""} ${d?"dim":""}"
                    style="--agent-color:${n}"
                    data-act="filter" data-pid="${z(i.person_id)}">
    ...
    `}var na=N(()=>{ut();Q();K()});function Dt(e){let t=e._attrs("sensor.family_hub_maintenance_due"),a=t.overdue||0,o=t.due_this_week||0,s=t.due_next_week||0,i=t.items||[],n=`
        ...
        </div>`,d=i.filter(u=>u.days_delta<0),p=i.filter(u=>u.days_delta>=0&&u.days_delta<=7),c=i.filter(u=>u.days_delta>7),g=[{label:"OVERDUE",items:d,cls:"overdue"},{label:"DUE THIS WEEK",items:p,cls:"this-week"},{label:"DUE NEXT WEEK",items:c,cls:"next-week"}].filter(u=>u.items.length).map(({label:u,items:x,cls:$})=>`
        ...
        <div class="fh-bk-tabs">
            ${[{key:"today",label:"Today",sub:"tonight"},{key:"week",label:"This Week",sub:"menu board"},{key:"plan",label:"Plan",sub:"day builder"},{key:"pantry",label:"What Can We Make",sub:"pantry"},{key:"library",label:"Library",sub:"recipes"},{key:"groceries",label:"Groceries",sub:"shopping"}].map(_=>`
                <button class="fh-bk-tab${c===_.key?" active":""}"
                        data-act="meals-tab" data-tab="${_.key}">
                    ${f(_.label)}
                    <span class="fh-bk-tab-sub">${_.sub}</span>
                </button>`).join("")}
        </div>`,u="";c==="today"?u=Ji(a,n,r,p,d):c==="week"?u=Ki(e,a,n):c==="plan"?u=Yi(e,a,n,s,o):c==="pantry"?u=tn(e,a,n,r,s,p):c==="library"?u=an(e,a,n,s,d,p):c==="groceries"&&(u=sn(e,a,n,r,i));let x=e._mealsRecipe?on(e._mealsRecipe,n,d,a):"",$=c==="plan"&&e._mealsDrawer?en(e,a,n,s):"",h=e._mealsDayPick?nn(e._mealsDayPick,a,n):"";return`
        ...
        </div>`}function ys(e,t,a,o,s,i,n){let r=a.d,d=r?V(r.main,o):null,p=r?(r.sides||[]).map(it).filter(Boolean):[],c=a.b?V(a.b,o):null,b=a.l?V(a.l,o):null,g=r&&r.protein&&de[r.protein]?de[r.protein].label.toLowerCase():null,u=e==="Today",x="";if(u&&(c||b||d)){let h=Oe(s),_=new Set(i||[]),S=[],v=E=>(E||[]).forEach(F=>{!_.has(F)&&!S.includes(F)&&S.push(F)});c&&!c.special&&v(c.ing),b&&!b.special&&v(b.ing),d&&!d.special&&v(Ot(d,r)),p.forEach(E=>v(E.ing));let m=S.map(E=>{let F=h.find(D=>D.id===E);return F?`<span class="fh-tdy-need"><span class="fh-tdy-need-g">${F.glyph}</span>${f(F.label)}</span>`:""}).join(""),w=d?Ke(d,n):null,C=w?`<div class="fh-tdy-prep">Dinner: <b>${f(w.time)}</b> \xB7 serves ${w.serves}</div>`:"";x=`
            <div class="fh-tdy-needs">
                <div class="fh-tdy-needs-hdr">What's needed today</div>
                ${S.length?`<div class="fh-tdy-needs-list">${m}</div>`:`<div class="fh-tdy-needs-none">\u2713 everything's on hand</div>`}
                ${C}
            </div>`}let $=d?`
        <span class="fh-tdy-glyph">${d.glyph}</span>
        <span class="fh-tdy-name">${f(d.name)}</span>
        ${r.variant?`<span class="fh-tdy-variant">${f(r.variant)}</span>`:g?`<span class="fh-tdy-variant">with ${f(g)}</span>`:""}
        ${p.length?`<span class="fh-tdy-sides">${p.map(h=>f(h.name)).join(" \xB7 ")}</span>`:""}
    `:'<span class="fh-tdy-empty">not planned yet</span>';return`
        <div class="fh-tdy-panel${u?" is-today":""}">
            ...
            ${x}
        </div>`}function Ki(e,t,a){let o=e._mealsWeekPage||0,s=0,i=st(),n=Et(i,s),r=Je(n,o*7),d=Math.floor((St-1)/7),p=o>0,c=o<d,b=Array.from({length:7},(v,m)=>Je(r,m)),g=b[6],u=r.getMonth()===g.getMonth()?`${Lt[r.getMonth()]} ${r.getDate()} \u2013 ${g.getDate()}`:`${ht[r.getMonth()]} ${r.getDate()} \u2013 ${ht[g.getMonth()]} ${g.getDate()}`,x=o===0?"this week":o===1?"next week":`${o} weeks out`,$=ma(t),h=`
        ...
        <div class="fh-ml-legendrow">
            ...
            <span class="fh-ml-weeknote-inline">
                ${$?`next open dinner: <b>${f(mt($))}</b> \u2014 tap any day to plan`:"every dinner is planned for the next month \u2014 <b>nicely done</b>"}
            </span>
        </div>`;return`
        <div class="fh-ml-content">
            ${h}
        ...
        ${r.variant?`<span class="fh-ml-dvariant">${f(r.variant)}</span>`:""}
    ...
    `,g=n?"":`data-act="meals-week-tap-day" data-date="${s}"`;return`
        ...
        </div>`}function Yi(e,t,a,o,s){let i=st(),n=e._mealsJumpDate||Z(i),r=ft(n),d=t[n]||{},p=0,c=Array.from({length:St},(S,v)=>Je(i,v)),b=[];c.forEach(S=>{let v=Z(Et(S,p)),m=b[b.length-1];if(!m||m.key!==v){let w=b.length===0?"This week":b.length===1?"Next week":`Week of ${ht[S.getMonth()]} ${Et(S,p).getDate()}`;m={key:v,label:w,days:[]},b.push(m)}m.days.push(S)});let g=`
        <div class="fh-ml-rail">
            ${b.map(S=>`
                <div class="fh-ml-rail-wk">${S.label}</div>
                ${S.days.map(v=>{let m=Z(v),w=t[m]||{};return`
                        <div class="${"fh-ml-rail-day"+(m===n?" active":"")+(m===Z(i)?" is-today":"")}" data-act="meals-plan-select-day" data-date="${m}">
        ...
        </div>`,$=Qi(d,a,n),h=Zi(d,a,n),_=Xi(s,p);return`
        <div class="fh-ml-content">
            <div class="fh-ml-bld">
                ${g}
        ...
        </div>`}function en(e,t,a,o){let s=e._mealsDrawer,{kind:i,dateISO:n,step:r}=s,d=ft(n),p=t[n]||{},c=i==="b"||i==="l",b=c?i:"d",g=i==="b"?"breakfast":i==="l"?"lunch":"dinner",u=ot(a),x=s.pendingMainId?V(s.pendingMainId,a):null,$=s.pickedProtein||null,h=new Set(s.selSides||[]),_=u.filter(A=>A.special&&A.types.includes(b));function S(A,B){return u.filter(L=>L.types.includes("d")&&!L.special&&L.protein===A&&(!B||L.cut===B))}function v(A){var B;return(((B=de[A])==null?void 0:B.cuts)||[]).filter(L=>S(A,L.id).length>0)}let m=s.cat||null,w=s.cut||null,C=s.scope||"today",E=s.favOnly||!1,F=s.nudgeOff||!1,D=s.fatsOff||!1,R=m?de[m].label:"",T=m&&w&&(de[m].cuts.find(A=>A.id===w)||{}).label||"",P=r==="protein"?"What's the protein?":r==="cut"?`Which ${R.toLowerCase()}?`:r==="make"?`${T||R} \u2014 what are we making?`:r==="sides"?x?`${x.glyph} ${x.name} \xB7 round out the plate`:"Round out the plate":r==="tacoprotein"?x?`${x.glyph} ${x.name} \u2014 pick the protein`:"Pick the protein":r==="confirm"?"All set \u2713":c?`Choosing ${g}`:"The whole library",y=`
        <div class="fh-ml-dr-head">
            ${!c&&i!=="d-sides"&&(r==="cut"||r==="make"||r==="browse"||r==="tacoprotein"||r==="sides"&&x)?'<button class="fh-ml-ghost-btn" data-act="meals-drawer-back">\u2039 Back</button>':""}
            ...
            ${c?`
                <div class="fh-ml-scope">
                    ${[["today","Just today"],["week","All week"],["2weeks","2 weeks"]].map(([A,B])=>`
                        <button class="fh-ml-scope-opt${C===A?" on":""}"
        ...
        <div class="fh-ml-dr-quick">
            ...
            </div>`;else if(r==="cut"&&m)M=`
            <div class="fh-ml-grid fh-ml-pgrid">
                ${v(m).map(A=>{let B=S(m,A.id).length;return`
                        <div class="fh-ml-mealcard fh-ml-pcard"
                             data-act="meals-drawer-pick-cut" data-cut="${A.id}">
                            <span class="fh-ml-mealcard-glyph" style="font-size:calc(2rem * var(--fh-text-scale,1))">${de[m].glyph}</span>
                            <span class="fh-ml-mealcard-name" style="font-size:var(--fh-text-sm)">${f(A.label)}</span>
                            <span class="fh-ml-pcount">${B} ${B===1?"idea":"ideas"}</span>
                        </div>`}).join("")}
            </div>`;else if(r==="make"&&m)M=`
            <div class="fh-ml-grid">
                ${(S(m,w).length?S(m,w):S(m)).map(B=>_s(B,o.includes(B.id),"meals-drawer-pick-main",{meal:B.id},!0)).join("")}
            ...
            </div>`}else if(r==="tacoprotein"&&x)M=`
            <div class="fh-ml-grid fh-ml-pgrid">
                ${(x.proteinPick||[]).map(A=>`
                    <div class="fh-ml-mealcard fh-ml-pcard${$===A?" on":""}"
                        ...
                        <span class="fh-ml-mealcard-name" style="font-size:var(--fh-text-base)">${f(de[A].label)}</span>
                    </div>`).join("")}
            </div>
                    ...
                    ${bt.map(ee=>`
                        <div class="fh-ml-side-col${ee.g==="veg"&&q&&!F?" cue":""}">
                            ...
                            <div class="fh-ml-side-colgrid">
                                ${ee.sides.map(te=>{let Ve=h.has(te.id),Zt=(te.pairs||[]).includes(B);return`
        ...
        <div class="fh-ml-panel">
            ...
            <div class="fh-ml-ingscroll">
                ${pt.map(([g,u])=>{let x=r.filter($=>$.cat===g);return x.length?`
                        <div class="fh-ml-ing-sec-hdr">
                            <span class="fh-ml-gicon on">${(Le[g]||{}).icon||"\u2022"}</span>
                            ${f(u)}
                        </div>
                        <div class="fh-ml-ingrid">
                            ${x.map($=>{let h=n.has($.id);return`
                                    <div class="fh-ml-ing-chip${h?" on":""}"
                                         data-act="meals-toggle-have" data-ing="${$.id}">
                                        ${h?'<span class="ck">\u2713</span>':""}
                                        <span class="fh-ml-ing-glyph">${$.glyph}</span>
                                        <span class="fh-ml-ing-lbl">${f($.label)}</span>
                                    </div>`}).join("")}
                        </div>`:""}).join("")}
            </div>
                    ...
                    <div class="fh-ml-match-row"
                        ...
                        <div class="fh-ml-match-body">
                            ...
                            <div class="fh-ml-match-uses">
                                ${(g.ing||[]).map($=>{let h=x.find(S=>S.id===$);if(!h)return"";let _=u.includes($);return`<span class="${_?"hit":""}">${_?"\u2713":"\xB7"}${f(h.label.toLowerCase())} </span>`}).join("")}
                            </div>
                        </div>
        ...
        </div>`}function an(e,t,a,o,s,i){let n=e._mealsLibFilter||"all",r=new Set(a.map(u=>u.id)),d=ot(a).filter(u=>!u.special).filter(u=>n==="all"?!0:u.types.includes(n)).sort((u,x)=>{let $=o.includes(u.id)?0:1,h=o.includes(x.id)?0:1;return $-h||u.name.localeCompare(x.name)}),p=`
        ...
        <div class="fh-ml-libgrid">
            ${d.map(u=>{let x=o.includes(u.id),$=!!Ke(u,s),h=ha(u,[]),_=$?"meals-open-recipe":u.types.includes("d")?"meals-lib-plan-meal":"";return`
                    <div class="fh-ml-mealcard fh-ml-libcard"
                         ${_?`data-act="${_}" data-meal="${u.id}"`:""}>
                        ...
                        ${$?'<span class="fh-ml-rbadge">RECIPE</span>':""}
                        ${h?'<span class="fh-ml-wgbadge">\u{1F33E} whole grain</span>':""}
                    </div>`}).join("")}
        </div>`,b=Ht(i),g=`
        ...
        <div class="fh-ml-discrow">
            ${b.map(({idea:u,hits:x})=>{let $=r.has(u.id);return`
                    <div class="fh-ml-mealcard fh-ml-disccard">
                        ...
                        <button class="fh-ml-disc-save${$?" saved":""}"
                                ${$?"disabled":`data-act="meals-save-idea" data-meal="${z(u.id)}"`}>
                            ${$?"In the library \u2713":"\uFF0B Save to library"}
                        </button>
                    </div>`}).join("")}
        </div>`;return`
        <div class="fh-ml-content">
        ...
        </div>`}function sn(e,t,a,o,s){let i=st(),n=Z(i),r=Oe(o),d={};for(let x=0;x<7;x++){let $=Je(i,x),h=t[Z($)];if(!h)continue;let _=rt[$.getDay()],S=(v,m)=>{v.forEach(w=>{let C=r.find(E=>E.id===w);C&&(d[w]||(d[w]={ing:C,sources:[]}),d[w].sources.length<2&&!d[w].sources.includes(m)&&d[w].sources.push(m))})};if(["b","l"].forEach(v=>{let m=h[v]?V(h[v],a):null;m&&!m.special&&S(m.ing||[],`${m.name} \xB7 ${_}`)}),h.d){let v=V(h.d.main,a);v&&!v.special&&S(Ot(v,h.d),`${v.name} \xB7 ${_}`),(h.d.sides||[]).forEach(m=>{let w=it(m);w&&S(w.ing||[],`${w.name} \xB7 ${_}`)})}}let p={};Object.values(d).forEach(x=>{let $=x.ing.aisle;p[$]||(p[$]=[]),p[$].push(x)}),Object.values(p).forEach(x=>x.sort(($,h)=>$.ing.label.localeCompare(h.ing.label)));let c=["produce","meat","dairy","bakery","pantry"].filter(x=>p[x]),b=Object.keys(d).length,g=Object.keys(d).filter(x=>s[n+":"+x]).length,u=b===0?`<div class="fh-ml-empty-note">plan a few meals first \u2014 the list builds itself from the week's menu</div>`:`
            <div class="fh-ml-groc-cols">
                ${c.map(x=>`
                    <div class="fh-ml-groc-sec">
                        <div class="fh-ml-groc-sec-hdr">${f(nt[x]||x)}</div>
                        ${p[x].map(({ing:$,sources:h})=>{let _=n+":"+$.id,S=!!s[_];return`
                                <div class="fh-ml-groc-row${S?" done":""}"
                                     data-act="meals-toggle-groc" data-key="${z(_)}" data-checked="${!S}">
                                    <span class="fh-ml-check">\u2713</span>
                                    <span class="fh-ml-groc-g">${$.glyph}</span>
                                    <div class="fh-ml-groc-body">
                                        <div class="fh-ml-groc-lbl">${f($.label)}</div>
                                        <div class="fh-ml-groc-from">${f(h.join("  \xB7  "))}</div>
                                    </div>
                                </div>`}).join("")}
                    </div>`).join("")}
            </div>`;return`
        ...
        <div class="fh-ml-plate" title="Food groups on the plate">
            ${Xe.map(t=>{let a=e.includes(t);return`<span class="fh-ml-gicon${a?" on":""}" title="${z(Le[t].label)}${a?"":" \u2014 not yet"}">${Le[t].icon}</span>`}).join("")}
        </div>`}function _s(e,t,a,o,s){let i=Object.entries(o).map(([r,d])=>`data-${r}="${z(d)}"`).join(" "),n=s?e.groups||[]:[];return`
      ...
      <div class="fh-drawer">
       ...
       <input type="hidden" id="m-amode" value="${e.type}">`,t?"Award":"Deduct","ok-point-adjust",t?"fh-btn-success":"fh-btn-danger")}function Ms(e){let t=parseInt(e.data.pts||"0"),a=[25,50,75].map(o=>{let s=Math.round(t*o/100);return`
          <button class="fh-btn fh-btn-primary" data-act="do-partial"
                  data-tid="${z(e.data.tid)}" data-frac="${o/100}"
      ...
      </div>`}function hn(e,t,a,o,s="details"){let i=e||{},n=i.recurrence||{},r=n.type||"daily",d=i.assigned_to||[],p=dn(i.icon),c=sa.find(T=>T.key===i.icon),b=c?c.label:i.icon||"",g=Array.isArray(n.days_of_month)&&n.days_of_month.length?n.days_of_month:n.day_of_month?[n.day_of_month]:[1],u=r==="one_time"?"daily":r,$=`
      ...
      <div class="fh-chore-tab-pane" data-tab="${T}"
        ...
        ${P}
      </div>`,_=new Map;for(let T of Ft){let P=T.category||"Other";_.has(P)||_.set(P,[]),_.get(P).push(T)}let S=[..._.entries()].map(([T,P])=>`
        <optgroup label="${z(T)}">
          ${P.map(l=>`<option value="${z(l.key)}">${f(l.name)}</option>`).join("")}
        </optgroup>`).join(""),m=h("details",`
        ${t?"":`
        ...
        <div class="fh-row">
          ...
          <div class="fh-field">
            ...
            <select class="fh-select" id="m-clabel">
              ...
              ${o.map(T=>`<option value="${z(T)}" ${T===i.category_label?"selected":""}>${T}</option>`).join("")}
            </select>
          </div>
        </div>
        <details class="fh-icon-details" open>
          ...
          <input type="hidden" id="m-cicon" value="${z(i.icon||"")}">
    ...
    `),w=i.rotation_pool||[],C=i.assigned_to&&i.assigned_to[0]||w[i.rotation_index||0]||w[0],E=w.indexOf(C);E<0&&(E=0);let F=w.length?w.slice(E).concat(w.slice(0,E)):[],D=h("schedule",`
        ...
        <div id="m-rotation-section" class="fh-field" style="display:none">
          ...
          <div id="m-rotation-config" class="fh-field" style="display:none">
            ...
            <input type="hidden" id="m-crot-pool-order" value="${z(F.join(","))}">
    ...
    `);return`
      ...
      <div id="m-sperson-section" class="fh-field" style="${r==="personal"&&!x?"":"display:none"}">
      ...
      <div class="fh-field" style="border-top:1px solid var(--fh-border);padding-top:10px;margin-top:4px">
        <label class="fh-label" style="display:flex;align-items:center;gap:10px;cursor:pointer">
          <label class="fh-toggle">
            <input type="checkbox" id="m-ssubtype" ${$?"checked":""} oninput="${T}">
            <span class="fh-toggle-slider"></span>
          </label>
      ...
      <div class="fh-drawer-tabs">
        ...
        ${a.map(v=>`
          <button class="fh-drawer-tab ${o===v.person_id?"active":""}"
                  data-act="ranks-tab" data-tab="${z(v.person_id)}">${f(v.name)}</button>`).join("")}
      </div>`;if(o==="global"){let v=t.rank_eval_weekday??0,m=t.rank_default_cap??100,w=t.rank_default_drop_pct??60,C=t.rank_default_gain_pct??80,E=t.rank_dynamic_capacity!==!1,F=t.rank_ppd_ladder||[3,3.5,4,4.5,5],D=s.map((P,l)=>`<option value="${l}" ${v==l?"selected":""}>${P}</option>`).join(""),R=F.map((P,l)=>`
          ...
          <div class="fh-row">
            ...
            <div class="fh-field">
              ...
              <input class="fh-input" id="m-rank-gain" type="number" min="0" max="100" value="${C}">
            </div>
          </div>
          ...
          <div class="fh-field">
            ...
            ${R}
          </div>`;return At("Ranks",T,"Save","save-ranks-global")}let n=a.find(v=>v.person_id===o);if(!n)return e._ranksTab="global",ba(e);let r=tt(n.theme_key||"classic").ranks,d=n.rank_index??0,p=n.rank_curve||{},c=p.cap??100,b=t.rank_dynamic_capacity!==!1,g=n.assigned_ppw??0,u=b?g:c,x=Array.isArray(p.gain_pcts)&&p.gain_pcts.length===5?p.gain_pcts:rn.slice(),$=Array.isArray(p.drop_pcts)&&p.drop_pcts.length===5?p.drop_pcts:ln.slice(),h=qt(u,x,$),_=r.map((v,m)=>{let w=m===r.length-1,C=m===0;return`
          <div class="fh-rank-grid-row">
            <span class="fh-rank-grid-name">${m===d?"\u25B6 ":""}${f(v.name)}</span>
            <span class="fh-rank-grid-cell">
              <input class="fh-input" id="m-drop-pct-${m}" type="number" min="0" max="100"
                     value="${C?"":$[m]}" ${C?"disabled placeholder='\u2014'":""}>
              <span class="fh-rank-grid-pts" id="m-drop-pts-${m}">${C?"\u2014":h.drop[m]}</span>
            </span>
            <span class="fh-rank-grid-cell">
              <input class="fh-input" id="m-gain-pct-${m}" type="number" min="0" max="100"
                     value="${w?"":x[m]}" ${w?"disabled placeholder='\u2014'":""}>
              <span class="fh-rank-grid-pts" id="m-gain-pts-${m}">${w?"\u2014":h.gain[m]}</span>
            </span>
          </div>`}).join(""),S=`
      ${i}
      <div class="fh-field-help">
        Theme <strong>${f(n.theme_key||"classic")}</strong> \xB7 currently
        <strong>${f(U(d,r).name)}</strong>
      </div>
      <div class="fh-field">
      ...
      <div class="fh-rank-summary" style="font-size:var(--fh-text-sm);margin:6px 0 2px;padding:8px 10px;border:1px solid var(--fh-border);border-radius:8px;background:var(--fh-surface)">
        Now: <strong>${f(U(d,r).name)}</strong>${b&&u<=0?" \xB7 no assigned chores \u2014 rank won't move":`${d<r.length-1?` \xB7 ranks up at <strong>\u2265 ${h.gain[d]} pts/wk</strong>`:" \xB7 top rank"}${d>0?` \xB7 drops below <strong>${h.drop[d]} pts/wk</strong>`:" \xB7 can't drop"}`}
      </div>
      ...
      <input type="hidden" id="m-rank-pid" value="${z(n.person_id)}">`;return At(`Ranks \u2014 ${f(n.name)}`,S,"Save","save-ranks-kid")}function Os(e,t){let a=t.filter(s=>s.type==="kid");if(!a.length)return`
          <div class="fh-modal">
         ...
         <div class="fh-field">
           ...
           <select class="fh-select" id="m-rrec">
             ${dt([{value:"daily",label:"Daily"},{value:"weekly",label:"Weekly"},{value:"every_n_days",label:"Every N days"},{value:"monthly_on_date",label:"Monthly"}],"daily")}
              ...
              <div class="fh-rot-item${p===0?" fh-rot-item--current":""}" data-pid="${z(d.person_id)}" style="--chip-color:${c}">
      ...
      <div class="fh-rot-available">${r}</div>`}function Hs(e,t,a,o){let s=Math.min(a,o),i=`
        ...
        <input type="hidden" id="m-chipin-pid" value="${z(t)}">`;return gt("Chip In \u2014 Group Reward",i,"Chip In","ok-chip-in")}function js(e,t,a){return e.length?`<div class="fh-person-cb-list">
      ...
      <div class="fh-ad-bottom-item ${h===C.id?"active":""}"
           data-act="admin-sec" data-sec="${C.id}">
      ...
      <div class="fh-ad-shell">
        ...
        <aside class="fh-ad-sidebar">
          ...
          <nav class="fh-ad-nav">${m}</nav>
        </aside>

        <div class="fh-ad-main">
          <div class="fh-ad-topbar">
            <div>
              <div class="fh-ad-topbar-crumb">${v.crumb}</div>
              <div class="fh-ad-topbar-title">${v.title}</div>
            </div>
            <div class="fh-ad-topbar-actions">${v.actions}</div>
          </div>
      ...
      </div>`}function Gs(e,t,a,o,s){let i=s.people||[],n=s.active_chores||[],r=s.history_log||[],p=(s.store_items||[]).filter(m=>{if(!m.is_group_reward||!m.active)return!1;let w=m.contributors||[];return w.length>0&&w.every(C=>(C.contributed_pts||0)>=(C.target_pts||0))}),b=[{label:"APPROVAL QUEUE",value:e.length,accent:e.length>0?"#F5C24A":"#58D38A"},{label:"REDEEM QUEUE",value:t.length,accent:t.length>0?"#E36DA4":"#58D38A"},{label:"GROUP PROPOSALS",value:a.length+p.length,accent:a.length+p.length>0?"#58D38A":"#A6B3CC"},{label:"ACTIVE CHORES",value:n.filter(m=>m.active!==!1).length,accent:"#5B8DEF"}].map(m=>`
      <div class="fh-ad-stat">
        <div class="fh-ad-stat-val" style="color:${m.accent}">${m.value}</div>
        <div class="fh-ad-stat-lbl">${m.label}</div>
      </div>`).join(""),g=[...e.map(m=>({...m,kind:"approval"})),...t.map(m=>({...m,kind:"redemption"})),...a.map(m=>({...m,kind:"group-proposal"})),...p.map(m=>({...m,kind:"group-funded"})),...o.map(m=>({...m,kind:"cancel-sub"}))],u=g.length>0?g.map(m=>{if(m.kind==="group-proposal"){let l=m.proposer_color||H,y=(m.invitees||[]).map(k=>k.person_name||"?").join(", ");return`
                  <div class="fh-ad-queue-row">
                    <div class="fh-avatar" style="background:${l};width:32px;height:32px;font-size:.75rem;flex-shrink:0">${j(m.proposer_name)}</div>
                    <div class="fh-ad-queue-info">
                      <div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">
                        <span class="fh-ad-pill" style="background:#4CAF7D">GROUP</span>
                      </div>
                      <div class="fh-ad-queue-name">${f(m.item_name||"")}</div>
                      <div class="fh-ad-queue-meta">${f(m.proposer_name)} + ${f(y)}</div>
                    </div>
                    <button class="fh-btn fh-btn-success fh-btn-sm"
                            data-act="approve-group-proposal"
                            data-propid="${z(m.proposal_id)}"
                  ...
                  </div>`}if(m.kind==="group-funded"){let l=(m.contributors||[]).reduce((k,M)=>k+(M.contributed_pts||0),0),y=(m.contributors||[]).map(k=>k.person_name||"?").join(", ");return`
                  <div class="fh-ad-queue-row">
                    ...
                    <div class="fh-ad-queue-info">
                      ...
                      <div class="fh-ad-queue-name">${f(m.name||"")}</div>
                      <div class="fh-ad-queue-meta">${f(y)} \xB7 ${O(l)} pts pooled</div>
                    </div>
                    <button class="fh-btn fh-btn-success fh-btn-sm"
                            data-act="redeem-group-reward"
                            data-iid="${z(m.item_id)}"
                            data-iname="${z(m.name||"")}">Redeem</button>
                  </div>`}if(m.kind==="cancel-sub"){let l=m.person_color||H,y=(m.period||"").replace("_"," ");return`
                  <div class="fh-ad-queue-row">
                    <div class="fh-avatar" style="background:${l};width:32px;height:32px;font-size:.75rem;flex-shrink:0">${j(m.person_name||"?")}</div>
                    <div class="fh-ad-queue-info">
                      <div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">
                        <span class="fh-ad-pill" style="background:#9B59B6">CANCEL</span>
                        <span class="fh-ad-queue-time">${ne(m.cancellation_requested_at||"")}</span>
                      </div>
                      <div class="fh-ad-queue-name">${f(m.item_name||"")}</div>
                      <div class="fh-ad-queue-meta">${f(m.person_name||"")} \xB7 ${f(y)} subscription</div>
                    </div>
                    <button class="fh-btn fh-btn-success fh-btn-sm"
                            data-act="approve-cancel-subscription"
                            data-subid="${z(m.subscription_id||m.id||"")}">${W.check}</button>
                    <button class="fh-btn fh-btn-danger fh-btn-sm"
                            data-act="decline-cancel-subscription"
                            data-subid="${z(m.subscription_id||m.id||"")}">${W.close}</button>
                  </div>`}let w=m.person_color||H,C=m.kind==="approval",E=C?m.chore_name||"":m.item_name||"",F=C?m.chore_points:m.points_cost,D=C?'<span class="fh-ad-pill fh-ad-pill--amber">CHORE</span>':'<span class="fh-ad-pill fh-ad-pill--rose">REWARD</span>',R=s.store_items||[],T=C?null:R.find(l=>l.item_id===m.item_id);if(!C&&(T==null?void 0:T.item_type)==="subscription"){let l=T.subscription_period||"monthly",y=z(m.redemption_id),M=l==="daily"?"":l==="weekly"?`<div style="display:flex;align-items:center;gap:6px;margin-top:6px;flex-wrap:wrap">
                  ...
                  <div class="fh-ad-queue-row" style="flex-wrap:wrap;row-gap:4px">
                    <div class="fh-avatar" style="background:${w};width:32px;height:32px;font-size:.75rem;flex-shrink:0">${j(m.person_name)}</div>
                    <div class="fh-ad-queue-info" style="flex:1;min-width:0">
                      <div style="display:flex;align-items:center;gap:6px;margin-bottom:2px">
                        <span class="fh-ad-pill" style="background:#9B59B6">SUBSCRIBE</span>
                        <span class="fh-ad-queue-time">${m.when||""}</span>
                      </div>
                      <div class="fh-ad-queue-name">${f(m.item_name||"")}</div>
                      <div class="fh-ad-queue-meta">${f(m.person_name||"")} \xB7 ${f(l)} \xB7 \u2212${O(F)}pts</div>
                      ${M}
                    </div>
                    <button class="fh-btn fh-btn-success fh-btn-sm"
                            data-act="approve-subscription-redemption"
                            data-rid="${y}"
                            data-period="${z(l)}">${W.check}</button>
                    <button class="fh-btn fh-btn-danger fh-btn-sm"
              ...
              <div class="fh-ad-queue-row">
                ...
                <div class="fh-ad-queue-info">
                  ...
                  <div class="fh-ad-queue-meta">${f(m.person_name||"")} \xB7 ${C?"+":"\u2212"}${O(F)}${C&&m.due_date?` \xB7 for ${f(mn(m.due_date))}`:""}</div>
                </div>
                <button class="fh-btn fh-btn-success fh-btn-sm" data-act="${C?"approve-task":"approve-redemption"}" data-${C?"tid":"rid"}="${C?m.task_id:m.redemption_id}">${W.check}</button>
                ${C?`<button class="fh-btn fh-btn-ghost fh-btn-sm" data-act="open-partial"
                        data-tid="${m.task_id}" data-name="${z(E)}" data-pts="${F}"
                        title="Partial credit" style="font-weight:800;font-size:1rem">\xBD</button>`:""}
                <button class="fh-btn fh-btn-danger  fh-btn-sm" data-act="${C?"deny-task":"decline-redemption"}" data-${C?"tid":"rid"}="${C?m.task_id:m.redemption_id}">${W.close}</button>
              </div>`}).join(""):'<div class="fh-empty fh-ad-empty">Nothing needs your attention right now. \u2713</div>',x=Date.now()-1728e5,$=r.filter(m=>new Date(m.timestamp).getTime()>x),h=new Map,_=[];for(let m of $)if(m.type==="task_skipped"){let w=m.skipped_date||(m.timestamp||"").slice(0,10)||"",C=`${m.person_id}:${w}`;h.has(C)||h.set(C,{personName:m.person_name||"",color:m.person_color||H,date:w,totalPts:0,count:0,timestamp:m.timestamp||""});let E=h.get(C);E.totalPts+=Math.abs(m.points_delta||0),E.count++,(m.timestamp||"")>E.timestamp&&(E.timestamp=m.timestamp)}else _.push(m);let S=[..._.map(m=>({kind:"entry",e:m})),...[...h.values()].map(m=>({kind:"skip",g:m}))].sort((m,w)=>{let C=m.kind==="entry"?m.e.timestamp||"":m.g.timestamp||"";return(w.kind==="entry"?w.e.timestamp||"":w.g.timestamp||"").localeCompare(C)}).slice(0,15),v=S.length>0?S.map(m=>{if(m.kind==="skip"){let{personName:T,color:P,date:l,totalPts:y,count:k}=m.g;return`
                  <div class="fh-ad-activity-row">
                    ...
                    <div style="flex:1;min-width:0">
                      ...
                      <div class="fh-ad-activity-meta" style="color:var(--fh-warning)">Skipped \xB7 ${f(l)}</div>
                    </div>
                  ...
                  </div>`}let w=m.e,C=ie[w.type]||{label:w.type,color:"#6F7E9C"},E=w.person_color||H,F=w.points_delta,D=F>0?"#58D38A":F<0?"#E8553E":"#6F7E9C",R=F?`<span style="font-family:'JetBrains Mono',monospace;font-size:var(--fh-text-xs);font-weight:700;color:${D};flex-shrink:0">${F>0?"+":""}${F}pts</span>`:"";return`
              <div class="fh-ad-activity-row">
                ...
                <div style="flex:1;min-width:0">
                  <div class="fh-ad-activity-name">
                    <span style="font-weight:700">${f(w.person_name||"")}</span>
                    ${f(w.chore_name||w.note||"")}
                  </div>
                  <div class="fh-ad-activity-meta" style="color:${C.color}">${f(C.label)}</div>
                </div>
                ${R}
      ...
      </div>`}function bn(e,t,a){let o=t.points_per_dollar||10,s=t.penalties_paused_global||!1,i=e.map(h=>{let _=h.avatar_color||H,S=h.penalties_paused||!1,v=h.type==="kid",m,w;return s?(m="Penalties & streaks off (global)",w="off-global"):S?(m="Penalties & streaks off",w="off"):(m="Penalties & streaks on",w=""),`
          <div class="fh-ad-person-card">
            <div class="fh-ad-person-top">
              <div class="fh-avatar" style="background:${_};width:40px;height:40px;font-size:1rem;flex-shrink:0">${j(h.name)}</div>
              <div style="flex:1;min-width:0">
                <div class="fh-ad-person-name">
                  ${f(h.name)}
                  <span class="fh-ad-person-type">${ea(h.type)}</span>
                  ${h.code?`<span class="fh-ad-person-code">${f(h.code)}</span>`:""}
                </div>
                <div class="fh-ad-person-bal">
                  ${O(h.points_balance)}pts \xB7 ${G(h.points_balance/o)} \xB7 lifetime ${O(h.points_lifetime)}${h.allowance_points>0?` \xB7 ${h.allowance_points}pts/${h.allowance_schedule==="monthly"?"mo":h.allowance_schedule==="biweekly"?"2wk":"wk"} allowance`:""}
                </div>
              </div>
            </div>
            ...
            ${v?`
              <div class="fh-ad-person-foot">
                <span class="fh-penalty-pause-label ${w}">${m}</span>
                ...
                <label class="fh-toggle" style="width:36px;height:20px"
                  ...
                  <input type="checkbox" data-act="toggle-person-penalty"
                         data-pid="${h.person_id}" ${S?"":"checked"}>
                  <span class="fh-toggle-slider"></span>
                </label>
              </div>`:""}
            <button class="fh-ad-person-del" data-act="open-confirm-remove-person"
                    data-pid="${h.person_id}" data-pname="${z(h.name)}"
                    title="Remove ${z(h.name)}">${W.trash}</button>
          </div>`}).join("")||'<div class="fh-empty fh-ad-empty">No people found.</div>',n=t.all_subscriptions||[],r=a._editingSubId||null,d=new Map;for(let h of n)d.has(h.person_id)||d.set(h.person_id,[]),d.get(h.person_id).push(h);let p={daily:"Daily",weekly:"Weekly",monthly:"Monthly",quarterly:"Quarterly",biannual:"Biannual",annual:"Annual"},c=[{v:"weekly",l:"Weekly"},{v:"monthly",l:"Monthly"},{v:"quarterly",l:"Quarterly"},{v:"biannual",l:"Biannual"},{v:"annual",l:"Annual"}],b={active:"Active",lapsed:"Lapsed",cancel_pending:"Cancel pending"},g={active:"var(--fh-success)",lapsed:"var(--fh-overdue)",cancel_pending:"var(--fh-warning)"},u=n.length===0?'<div class="fh-empty fh-ad-empty">No active subscriptions.</div>':[...d.entries()].map(([h,_])=>{let S=_[0].person_color||H,v=_[0].person_name||"Unknown",m=_.map(w=>{let C=w.subscription_id,E=C===r,F=g[w.status]||"var(--fh-text-sec)",D=b[w.status]||w.status,R=p[w.period]||w.period,T=w.accumulated_debt>0?`<span style="color:var(--fh-overdue);font-size:.75rem"> \xB7 owes ${O(w.accumulated_debt)}pts</span>`:"",P=w.dollar_cost_override!=null?`${G(w.effective_dollar)} (override) \xB7 ${O(w.effective_cost)}pts`:`${G(w.effective_dollar)} \xB7 ${O(w.effective_cost)}pts`;if(E){let l=c.map(y=>`<option value="${y.v}"${w.period===y.v?" selected":""}>${y.l}</option>`).join("");return`
                      <div style="padding:10px 0;border-bottom:1px solid var(--fh-border)">
                        <div style="font-size:.88rem;font-weight:600;margin-bottom:8px">${f(w.item_name)}</div>
                        <div style="display:grid;grid-template-columns:90px 1fr;gap:5px 10px;align-items:center;margin-bottom:8px">
                          ...
                          <select id="sub-edit-period-${z(C)}" class="fh-input" style="height:28px;font-size:.8rem;padding:0 6px">
                            ${l}
                          </select>
                          <label style="font-size:.75rem;color:var(--fh-text-sec)">Cost override $</label>
                          <input id="sub-edit-cost-${z(C)}"
                          ...
                          <input id="sub-edit-date-${z(C)}"
                                 type="date"
                                 value="${z(w.next_renewal_date||"")}"
                                 class="fh-input" style="height:28px;font-size:.8rem;padding:0 6px">
                        </div>
                  ...
                  <div class="fh-point-row" style="gap:8px;padding:8px 0;border-bottom:1px solid var(--fh-border)">
                    <div style="flex:1;min-width:0">
                      <div style="display:flex;align-items:center;gap:6px;margin-bottom:3px">
                        <span style="font-size:.88rem;font-weight:600">${f(w.item_name)}</span>
        ...
        <div class="fh-ad-panel-body">
          ...
          ${x.map(h=>`
            <div style="display:flex;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--fh-border)">
              <div class="fh-avatar" style="background:${h.avatar_color||H};width:30px;height:30px;font-size:.85rem;flex-shrink:0">${j(h.name)}</div>
              <div style="flex:1;min-width:0">
                <span style="font-weight:600;font-size:var(--fh-text-base)">${f(h.name)}</span>
                <span style="font-size:var(--fh-text-xs);color:var(--fh-text-sec)"> \xB7 ${ea(h.type)} \xB7 lifetime ${O(h.points_lifetime)}</span>
              </div>
              ...
              <button class="fh-btn fh-btn-danger fh-btn-sm" data-act="open-confirm-hard-delete-person"
                      data-pid="${h.person_id}" data-pname="${z(h.name)}"
                      title="Permanently delete ${z(h.name)}">${W.trash}</button>
            </div>
          `).join("")}
        </div>
      </div>`;return`
      ...
      <select class="fh-select fh-ad-filter-select" data-act="${R}">
        ${T.map(l=>`<option value="${z(l.val)}" ${String(P)===String(l.val)?"selected":""}>${f(l.label)}</option>`).join("")}
      </select>`,b=`
      ...
      </div>`,_=new Map;for(let R of a)_.set(R,[]);for(let R of x){let T=R.category_label||"Uncategorized";_.has(T)||_.set(T,[]),_.get(T).push(R)}for(let[R,T]of[..._.entries()])T.length||_.delete(R);let S=o._adminSelectedChoreId||null,v=o._adminCollapsedCats||new Set,m=e.filter(R=>R.active!==!1).length,w=e.filter(R=>R.active===!1).length,C=w?`${m} active \xB7 ${w} inactive`:`${m} total`,E=o._choreFilter||i||s,F="";x.length?F=[..._.entries()].map(([R,T])=>{let P=v.has(R),l=P?"":T.map(y=>xn(y,t,o,S)).join("");return`
              <div class="fh-ad-cat-group">
                <div class="fh-ad-cat-hdr" data-act="toggle-admin-cat" data-cat="${z(R)}">
      ...
      <div class="fh-ad-tasks-wrap">
        ...
        <div class="fh-ad-panel fh-ad-tasks-list-panel">
          <div class="fh-ad-panel-hdr">
            ...
            <span class="fh-ad-panel-sub">${C}</span>
          </div>
          <div class="fh-ad-panel-body">
            ${b}
            ${h}
      ...
      </div>`}function vn(e,t){let a=qs(e,t);if(!a)return null;let o=(i,n)=>{let r=t.find(c=>c.person_id===i),d=(r==null?void 0:r.name)||"?",p=(r==null?void 0:r.avatar_color)||H;return`<div class="fh-avatar ${n}" title="${z(d)}" style="background:${p};width:26px;height:26px;font-size:var(--fh-text-xs)">${j(d)}</div>`};return`<span class="fh-rot-glyph" title="Rotates between kids">\u21BB</span><div class="fh-avatars fh-avatars--rot">${a.orderedIds.map((i,n)=>o(i,n===0?"fh-avatar--current":n===1?"fh-avatar--next":"fh-avatar--dim")).join("")}</div>`}function xn(e,t,a,o){var h,_,S,v;let s=(e.assigned_to||[]).map(m=>t.find(w=>w.person_id===m)).filter(Boolean),i=vn(e,t),n=i??(s.length?`<div class="fh-avatars">${s.map(m=>`<div class="fh-avatar" style="background:${m.avatar_color||H};width:26px;height:26px;font-size:var(--fh-text-xs)">${j(m.name)}</div>`).join("")}</div>`:""),r=a._expandedDescs.has(e.chore_id),d=((h=s[0])==null?void 0:h.avatar_color)||H,p=((_=e.recurrence)==null?void 0:_.type)||"daily",c={daily:"Daily",weekly:"Weekly",every_n_days:`Every ${((S=e.recurrence)==null?void 0:S.interval)||2}d`,every_n_weeks:`Every ${((v=e.recurrence)==null?void 0:v.interval)||2}wk`,monthly_on_date:"Monthly",one_time:"One-time"}[p]||p,b=e.expires_after_days?`<span class="fh-badge fh-badge-expiry" style="margin-left:4px">Expires in ${e.expires_after_days}d</span>`:"",g=e.streak_milestone||0,u=e.streak_bonus_points||0,x=g>0&&u>0?`<span class="fh-task-streak" title="Bonus: +${u}pts every ${g} completions">\u{1F525} ${g} \u2192 +${u}</span>`:'<span class="fh-task-streak fh-task-streak--off" title="No streak bonus set">no streak</span>';return`
      <div class="fh-task-row${e.chore_id===o?" fh-task-row--selected":""}"
        ...
        <div class="fh-task-body">
          ...
          ${r&&e.description?`<span class="fh-desc-inline">${f(e.description)}</span>`:""}
      ...
      </div>`}function yn(e){let t=e.recurrence||{};switch(t.type||"daily"){case"daily":return(t.day_filter||[]).length||7;case"weekly":return(t.weekdays||[]).length||1;case"every_n_days":{let a=t.interval||1;return a>0?7/a:0}case"every_n_weeks":{let a=t.interval||1;return a>0?1/a:0}case"monthly_on_date":return(t.days_of_month&&t.days_of_month.length?t.days_of_month.length:1)*12/52;default:return 0}}function qs(e,t){let a=e.rotation_pool||[];if(!a.length||!e.rotation_cadence)return null;let o=d=>{let p=t.find(c=>c.person_id===d);return p&&p.active!==!1},s=a.filter(o);if(!s.length)return null;let i=e.assigned_to&&e.assigned_to[0]||s[0],n=s.indexOf(i);n<0&&(n=0);let r=s.slice(n).concat(s.slice(0,n));return{activeIds:s,orderedIds:r,currentId:r[0],nextId:s.length>1?r[1]:null,cadence:e.rotation_cadence,switchWeekday:e.rotation_switch_weekday??0}}function wn(e,t){for(e=Math.round(e),t=Math.round(t);t;)[e,t]=[t,e%t];return e||1}function kn(e,t){return Math.abs(e*t)/wn(e,t)}function Js(e,t){let a=yn(e);if(a<=0)return 0;let o=a*(e.points||0)*t.comp;return t.includeStreaks&&e.streak_milestone>0&&e.streak_bonus_points>0&&(o+=a*(e.streak_bonus_points/e.streak_milestone)*t.streakPct),o}function _n(e,t,a){let o=t.filter(v=>v.type==="kid"&&v.active!==!1),s=o.map(v=>v.person_id),i={},n={};s.forEach(v=>{i[v]=0,n[v]=0});let r=[];for(let v of e){let m=Js(v,a);if(m<=0)continue;let w=qs(v,t);if(w&&w.cadence==="weekly")r.push({eff:m,ordered:w.orderedIds,name:v.name}),n[w.currentId]!=null&&(n[w.currentId]+=1);else if(w){let C=m/w.activeIds.length;w.activeIds.forEach(E=>{i[E]!=null&&(i[E]+=C)}),n[w.currentId]!=null&&(n[w.currentId]+=1)}else for(let C of v.assigned_to||[])i[C]!=null&&(i[C]+=m,n[C]+=1)}let d={};s.forEach(v=>d[v]=i[v]);for(let v of r){let m=v.eff/v.ordered.length;v.ordered.forEach(w=>{d[w]!=null&&(d[w]+=m)})}let p=1;for(let v of r)p=kn(p,v.ordered.length);p=Math.max(1,Math.min(p,12));let c={},b={},g={};s.forEach(v=>{c[v]=i[v],b[v]=i[v],g[v]=i[v]});for(let v=0;v<p;v++){let m={};s.forEach(w=>m[w]=i[w]);for(let w of r){let C=w.ordered[v%w.ordered.length];m[C]!=null&&(m[C]+=w.eff)}s.forEach(w=>{v===0?(g[w]=m[w],c[w]=m[w],b[w]=m[w]):(m[w]<c[w]&&(c[w]=m[w]),m[w]>b[w]&&(b[w]=m[w]))})}let u={},x={};o.forEach(v=>{let m=v.allowance_points||0,w=v.allowance_schedule||"weekly";w==="biweekly"?(u[v.person_id]=m/2,x[v.person_id]=m*2):w==="monthly"?(u[v.person_id]=m/4,x[v.person_id]=m):(u[v.person_id]=m,x[v.person_id]=m*4)});let $=a.ladder,h=v=>{let m=a.rankOverride!=null?a.rankOverride:v.rank_index||0;return $&&$.length?$[Math.max(0,Math.min(m,$.length-1))]:a.ppd>0?100/a.ppd:0},_=(v,m)=>m*h(v)/100,S=o.map(v=>{let m=v.person_id,w=d[m]*4;return{person:v,chores:n[m],month:w,monthUSD:_(v,w),weekAvg:d[m],weekAvgUSD:_(v,d[m]),weekMin:c[m],weekMax:b[m],weekThis:g[m],weekThisUSD:_(v,g[m]),swingUSD:_(v,b[m]-c[m]),allowMo:x[m],allowMoUSD:_(v,x[m]),allowWkUSD:_(v,u[m]),takeHomeMoUSD:_(v,w+x[m]),takeHomeWkUSD:_(v,d[m]+u[m])}});return{rows:S,famWeek:S.reduce((v,m)=>v+m.weekAvg,0),famMonth:S.reduce((v,m)=>v+m.month,0),famWeekUSD:S.reduce((v,m)=>v+m.weekAvgUSD,0),famMonthUSD:S.reduce((v,m)=>v+m.monthUSD,0),maxWeekMax:Math.max(1,...S.map(v=>v.weekMax)),maxMonth:Math.max(1,...S.map(v=>v.month)),weeklyRotChores:r.map(v=>v.name),centsOfRank:v=>$&&$.length?$[Math.max(0,Math.min(v,$.length-1))]:a.ppd>0?100/a.ppd:0}}function $n(e){var w;let t=e._attrs("sensor.family_hub_needs_attention"),a=t.people||[],o=t.active_chores||[],s=t.points_per_dollar||0,i=t.rank_ppd_ladder&&t.rank_ppd_ladder.length?t.rank_ppd_ladder:[3,3.5,4,4.5,5],n=e._statsCompletionPct??100,r=!!e._statsIncludeStreaks,d=e._statsStreakPct??50,p=e._statsRankOverride==null||e._statsRankOverride===""?null:Number(e._statsRankOverride),c={comp:n/100,includeStreaks:r,streakPct:d/100,rankOverride:p,ladder:i,ppd:s},b=o.filter(C=>C.chore_type==="assigned"),g=o.filter(C=>C.chore_type==="claimable"),u=_n(b,a,c),x=C=>O(Math.round(C||0)),$=[`<option value="" ${p==null?"selected":""}>Current</option>`].concat(i.map((C,E)=>`<option value="${E}" ${p===E?"selected":""}>Rank ${E+1}</option>`)).join(""),h=[100,95,90,85,80,75,70,60,50].map(C=>`<option value="${C}" ${n===C?"selected":""}>${C}%</option>`).join(""),_=[100,75,50,25].map(C=>`<option value="${C}" ${d===C?"selected":""}>${C}%</option>`).join(""),S=`
      <div class="fh-es-controls">
        ...
        ${r?`<label class="fh-es-ctl">Streak <select class="fh-select" data-act="stats-streak-pct">${_}</select></label>`:""}
      </div>`,v=[`${b.length} chore${b.length===1?"":"s"}`,`${n}% done`];r&&v.push(`streaks ${d}%`),p!=null&&v.push(`at Rank ${p+1}`);let m;if(!u.rows.length)m=`
          ...
          </div>`;else{let C=u.maxWeekMax||1,E=u.rows.map(l=>{let y=l.person.avatar_color||H,k=Math.max(0,l.weekMax-l.weekMin),M=k>.5,A=Math.max(0,Math.min(100,l.weekMin/C*100)),B=Math.max(0,Math.min(100,k/C*100)),L=Math.max(0,Math.min(100,l.weekThis/C*100)),q=M?`<span class="fh-es-week-this">this wk ${G(l.weekThisUSD)}</span>`:"",J=l.allowMo>0?`<div class="fh-es-allow">+${G(l.allowWkUSD)}/wk allowance \u2192 <b>${G(l.takeHomeWkUSD)}</b>/wk take-home</div>`:"";return`
              <div class="fh-es-kid">
                <div class="fh-es-kid-hdr">
                  ...
                  <span class="fh-es-kid-name">${f(l.person.name)}</span>
                ...
                <div class="fh-es-week">
                  ...
                  <span class="fh-es-week-pts">${x(l.weekAvg)} pts</span>
                  ${q}
                </div>
                ...
                <div class="fh-es-month-sub">${x(l.month)} pts \xB7 ${G(l.monthUSD)} / month</div>
                ${J}
              </div>`}).join(""),F=`
          <div class="fh-es-section">
            ...
            ${u.rows.map(l=>{let y=Math.round(l.month/u.maxMonth*100);return`
                  <div class="fh-es-bar-row">
                    <span class="fh-es-bar-name">${f(l.person.name)}</span>
          ...
          <div class="fh-es-section">
            ...
            <div class="fh-es-tot-row"><span>Per month</span><span>${x(u.famMonth)} pts \xB7 ${G(u.famMonthUSD)}</span></div>
              ...
              <div class="fh-es-section">
                ...
                <div class="fh-es-tot-row"><span>Per week</span><span>${x(l)} pts \xB7 ${G(k(l))}</span></div>
                <div class="fh-es-tot-row"><span>Per month</span><span>${x(l*4)} pts \xB7 ${G(k(l*4))}</span></div>
              ...
              <div class="fh-es-tip">
                <b>Weekly pay varies up to ${G(y)}</b> week-to-week for ${f(l)} (anti-phased) from ${k.length} weekly rotation${k.length===1?"":"s"} \u2014 ${f(M)}. Switch those to per-instance rotation to even the weeks out.
              </div>`}m=`<div class="fh-es-rail">${E}${F}${D}${R}${T}</div>`}return`
      ...
      </div>`,i=e;o._storeItemFilter==="active"&&(i=e.filter(h=>h.active!==!1)),o._storeItemFilter==="inactive"&&(i=e.filter(h=>h.active===!1));let n=o._adminSortItems||{col:null,dir:"asc"},r=[...i];n.col&&r.sort((h,_)=>{let S,v;switch(n.col){case"name":S=h.name.toLowerCase(),v=_.name.toLowerCase();break;case"pts":S=h.points_cost,v=_.points_cost;break;case"cat":S=h.category_label||"",v=_.category_label||"";break;case"scope":S=h.scope||"",v=_.scope||"";break;default:S=v=""}return S<v?n.dir==="asc"?-1:1:S>v?n.dir==="asc"?1:-1:0});let p=`
      <div class="fh-ad-sort-bar">
        <span class="fh-ad-sort-lbl">Sort:</span>
        ${[{col:"name",label:"Name"},{col:"pts",label:"Pts"},{col:"cat",label:"Category"},{col:"scope",label:"Scope"}].map(({col:h,label:_})=>{let S=n.col===h,v=S?n.dir==="asc"?" \u2191":" \u2193":"";return`<button class="fh-ad-sort-btn${S?" active":""}"
                            data-act="sort-admin-store-items" data-col="${h}">${_}${v}</button>`}).join("")}
        ${n.col?'<button class="fh-ad-sort-btn" data-act="sort-admin-store-items" data-col="">\u2715 Clear</button>':""}
      </div>`,c=new Map;for(let h of a)c.set(h,[]);for(let h of r){let _=h.category_label||"Uncategorized";c.has(_)||c.set(_,[]),c.get(_).push(h)}for(let[h,_]of[...c.entries()])_.length||c.delete(h);let b=o._adminSelectedItemId||null,g=o._adminCollapsedRewardCats||new Set,u="";r.length?u=[...c.entries()].map(([h,_])=>{let S=g.has(h),v=S?"":_.map(m=>En(m,t,o,b)).join("");return`
              <div class="fh-ad-cat-group">
              ...
              </div>`}).join(""):u=`<div class="fh-empty fh-ad-empty">${o._storeItemFilter?"No rewards match this filter.":"No rewards yet. Add one above."}</div>`;let x=b?e.find(h=>h.item_id===b):null,$=Cn(x,t,a,o);return`
        ...
        <button class="fh-btn fh-btn-danger fh-btn-sm"
          ...
          <div class="fh-ad-tasks-panel-hdr">
            <div style="flex:1;min-width:0">
              ...
              <div class="fh-ad-tasks-panel-sub" title="${z(e.name)}">${f(e.name)}</div>
            </div>
      ...
      <div class="fh-cat-chip"
        ...
        <button class="fh-cat-chip-del" data-act="remove-cat-label"
                data-label="${z(h)}" title="Remove">\xD7</button>
      </div>`).join(""),x=e.modules||{},$=zt.map(h=>{var C;let S=(((C=p[h.id])==null?void 0:C.status)??h.status)!=="hidden",v=h.status==="coming",m=x[h.id]===!1,w=m?" \xB7 <em>module off \u2014 manage in integration options</em>":v?" \xB7 <em>coming soon</em>":"";return`
          <div class="fh-hub-room-row${m?" fh-hub-room-row--off":""}" data-room-id="${z(h.id)}">
            <div class="fh-hub-room-icon" style="color:${h.accent}">${h.icon}</div>
            <div class="fh-hub-room-info">
              <div class="fh-hub-room-name">${f(h.label)}</div>
              <div class="fh-hub-room-sub">${f(h.sub)}${w}</div>
            </div>
            <label class="fh-toggle">
      ...
      <div class="fh-ad-settings-grid">
        ...
        <div class="fh-ad-panel fh-ad-settings-hub">
          ...
          <div class="fh-ad-panel-body">
            ...
            <div class="fh-hub-room-list">${$}</div>
            <div class="fh-divider"></div>
            <div class="fh-field">
...
`))}</textarea>
      ...
      <div class="fh-hist-group">
        ...
        <button class="fh-ml-qchip${i===p?" on":""}" data-act="meals-admin-subtab" data-sub="${p}">${c}</button>`,r=`<div class="fh-ml-adm-tabs">${n("meals","Meals")}${n("ingredients","Ingredients")}${n("recipes","Recipes")}</div>`,d="";return i==="meals"?d=Fn(a,o):i==="ingredients"?d=Rn(o):d=Dn(e,a,s),`<div class="fh-ml-page" style="padding:4px 2px">${r}${d}</div>`}function Fn(e,t){let a=Oe(t),o=(r,d)=>`<label class="fh-ml-chk"><input type="checkbox" id="${r}">${f(d)}</label>`,s=$t.map(r=>{let d=de[r];return`<optgroup label="${z(d.label)}">`+d.cuts.map(p=>`<option value="${r}:${p.id}">${f(d.label)} \xB7 ${f(p.label)}</option>`).join("")+"</optgroup>"}).join(""),i=`
      <div class="fh-ml-panel">
        ...
        <div class="fh-ml-admin-list">
          ${e.length===0?'<div class="fh-ml-empty-note">nothing added yet \u2014 meals you add (or save from Recipe Ideas) land here</div>':e.map(r=>`
              <div class="fh-ml-admin-row">
                ...
                <span class="nm">${f(r.name)}<div class="meta">${(r.types||[]).map(d=>d==="b"?"BREAKFAST":d==="l"?"LUNCH":"DINNER").join(" \xB7 ")}${r.source?" \xB7 "+f(String(r.source).toUpperCase()):""}</div></span>
                <button class="fh-ml-xbtn" data-act="meals-admin-remove-meal" data-id="${z(r.id)}">\u2715</button>
              </div>`).join("")}
        </div>
        ...
        <div class="fh-ml-admin-list">
          ${e.length===0?'<div class="fh-ml-empty-note">nothing added yet \u2014 new ingredients show up in the pantry chips and grocery aisles</div>':e.map(i=>`
              <div class="fh-ml-admin-row">
                ...
                <button class="fh-ml-xbtn" data-act="meals-admin-remove-ing" data-id="${z(i.id)}">\u2715</button>
              </div>`).join("")}
        </div>
        ...
        <div class="fh-ml-admin-list">
          ${o.map(d=>{let p=!!Ke(d,a);return`
              <div class="fh-ml-admin-row"${e._mealsAdminRecipeId===d.id?' style="background:rgba(139,58,42,.08)"':""}>
                ...
                <button class="fh-ml-ghost-btn" data-act="meals-admin-recipe-edit" data-id="${z(d.id)}">${p?"Edit":"\uFF0B Add"}</button>
              </div>`}).join("")}
        </div>
            ...
            <div class="fh-ml-form">
              <div style="display:grid;grid-template-columns:1.6fr 1fr;gap:10px">
                <div><label class="fh-ml-flabel">Time</label>
                  <input class="fh-ml-input" id="mr-time" value="${z(d.time||"")}" placeholder="e.g. 30 min"></div>
                <div><label class="fh-ml-flabel">Serves</label>
                  <input class="fh-ml-input" id="mr-serves" inputmode="numeric" value="${z(String(d.serves||5))}"></div>
              </div>
...
`))}</textarea>
              <div style="display:flex;justify-content:flex-end;gap:10px;padding-top:6px">
                ...
                <button class="fh-bk-go-btn" data-act="meals-admin-recipe-save" data-id="${z(n.id)}">Save recipe \u2713</button>
              </div>
            </div>
    ...
    `}function Tn(e,t,a){if(!e.length)return"";let o=a._attrs("sensor.family_hub_claimable_tasks").all_tasks||[];return`
        <div class="fh-home-section">
            ...
            <div class="fh-home-agents-row">${e.map(i=>{var m;let n=i.avatar_color||H,r=i.code||"",d=tt(i.theme_key||"classic"),p=d.tint,c=d.sigil,b=a._personEntityId(i.name),g=a._attrs(b),u=parseInt(((m=a._states(b))==null?void 0:m.state)??i.lifetime_points??0),x=g.show_dollar_value?g.dollar_value:null,$=d.rankTitle(i.rank_index!==void 0?i.rank_index:0),h=d.homeTileSubLabel(i),_=o.filter(w=>w.assigned_to===i.person_id&&w.status==="pending").length,S=t.filter(w=>w.person_id===i.person_id).length,v=i.allowance_points&&i.allowance_schedule?`<div class="fh-home-agent-allowance">+${i.allowance_points}/${i.allowance_schedule==="weekly"?"wk":i.allowance_schedule==="bi_weekly"?"2wk":"mo"}</div>`:"";return`
            <div class="fh-home-agent-tile"
                 data-act="nav" data-nav-view="person:${z(i.person_id)}"
                ...
                <div class="fh-home-agent-code">AGT &middot; ${r?f(r):f(i.name.toUpperCase())}</div>
                <div class="fh-home-agent-name">${f(i.name)}</div>
                <div class="fh-home-agent-sublabel">${f($)} &middot; ${f(h)}</div>
        ...
        <div class="fh-home-section">
            ...
            <div class="fh-home-room-stat">
                ...
                <span class="fh-home-room-stat-lbl">${f(g.label)}</span>
            </div>
        `).join("");return`
            <div class="fh-home-room-tile ${r?"live":"coming"}"
                 data-act="nav" data-nav-view="room:${z(s.id)}"
    ...
    `}var ao=N(()=>{eo();Q()});function so(e){let t=(e==null?void 0:e.type)||"daily";if(t==="daily"){let a=e.day_filter||[];if(!a.length||a.length===7)return"Every day";let o=[...a].sort((i,n)=>i-n),s=!0;for(let i=1;i<o.length;i++)if(o[i]!==o[i-1]+1){s=!1;break}return s&&o.length>=3?`${Vt[o[0]]}\u2013${Vt[o[o.length-1]]}`:o.map(i=>Vt[i]).join(" ")}if(t==="weekly"){let a=e.weekdays||[];return a.length?a.map(o=>Vt[o]).join(" "):"Weekly"}return t==="every_n_days"?`Every ${e.interval||2} days`:t==="every_n_weeks"?`Every ${e.interval||2} weeks`:t==="monthly_on_date"?"Monthly":t==="one_time"?"One time":t}function Hn(e){let t=(e==null?void 0:e.type)||"daily";if(t==="daily")return(e.day_filter||[]).length||7;if(t==="weekly")return(e.weekdays||[]).length||1;if(t==="every_n_days"){let a=e.interval||1;return a>0?7/a:0}if(t==="every_n_weeks"){let a=e.interval||1;return a>0?1/a:0}return t==="monthly_on_date"?(e.days_of_month&&e.days_of_month.length?e.days_of_month.length:1)*12/52:0}function jn(e){let t=e.rotation_cadence;return t==="weekly"?"Weekly":t==="per_instance"?"Each time":t==="daily"?"Daily":t||"\u2014"}function ya(e){let t=[];return e.points>0&&t.push(`<span class="pl-pts">+${e.points}</span>`),e.penalty_enabled&&e.penalty_points>0&&t.push(`<span class="pl-penalty">\u2212${e.penalty_points}</span>`),t.join("")}function Gn(e){let t=e.description?`<div class="pl-desc">${X(e.description)}</div>`:"";return`
        ...
        <table class="pl-table">
      ...
      </section>`}function Wn(e){let t=(e==null?void 0:e.family_name)||"Family",a=(e==null?void 0:e.people)||[],o=(e==null?void 0:e.active_chores)||[],s=e!=null&&e.rank_ppd_ladder&&e.rank_ppd_ladder.length?e.rank_ppd_ladder:[3,3.5,4,4.5,5],i=Math.min(2,s.length-1),n=s[Math.max(0,i)],r=l=>`$${(l*n/100).toFixed(2)}`,d=new Date().toLocaleDateString(void 0,{weekday:"long",year:"numeric",month:"long",day:"numeric"}),p=a.filter(l=>l.type==="kid"&&l.active!==!1),c=p.map(l=>l.person_id),b=l=>{var y;return((y=a.find(k=>k.person_id===l))==null?void 0:y.name)||"\u2014"},g=l=>{var y;return((y=a.find(k=>k.person_id===l))==null?void 0:y.active)!==!1},u=l=>(l.rotation_pool||[]).length>1&&l.rotation_cadence,x=l=>c.length>0&&c.every(y=>(l.assigned_to||[]).includes(y)),$=[],h=[],_=[],S=[],v=new Map;p.forEach(l=>v.set(l.person_id,[]));for(let l of o){if(l.chore_type==="reminder"){let y=l.assigned_to||[];(!y.length||y.some(k=>c.includes(k)))&&S.push(l);continue}if(l.chore_type==="claimable"){_.push(l);continue}if(u(l)){h.push(l);continue}if(x(l)){$.push(l);continue}for(let y of l.assigned_to||[])v.has(y)&&v.get(y).push(l)}let m={};c.forEach(l=>m[l]=0);for(let l of o){if(l.chore_type!=="assigned")continue;let y=Hn(l.recurrence)*(l.points||0);if(!(y<=0))if(u(l)){let k=(l.rotation_pool||[]).filter(A=>c.includes(A)&&g(A));if(!k.length)continue;let M=y/k.length;k.forEach(A=>{m[A]+=M})}else for(let k of l.assigned_to||[])m[k]!=null&&(m[k]+=y)}let w='<span class="pl-rot" title="Rotates">\u21BB</span> ',C=(l,y)=>{let k=l.description?`<div class="pl-desc">${X(l.description)}</div>`:"";return`
          <tr>
            <td class="pl-name"><div>${y?w:""}${X(l.name)}</div>${k}</td>
            <td class="pl-when">${X(so(l.recurrence))}</td>
            <td class="pl-points">${ya(l)}</td>
          </tr>`},E=p.map(l=>{let y=v.get(l.person_id)||[],k=h.filter(B=>((B.assigned_to||[])[0]||null)===l.person_id),M=Math.round(m[l.person_id]||0),A=y.length||k.length?`<table class="pl-table">
                 <thead><tr><th>Chore</th><th>When</th><th class="pl-points">Pts</th></tr></thead>
                 <tbody>${y.map(B=>C(B,!1)).join("")}${k.map(B=>C(B,!0)).join("")}</tbody>
          ...
          <section class="pl-section">
            ...
            <table class="pl-table pl-rot-table">
              ...
              <tbody>${h.map(y=>{let k=(y.rotation_pool||[]).filter(g),M=(y.assigned_to||[])[0]||k[0],A=k.map(B=>B===M?`<b>${X(b(B))}</b>`:X(b(B))).join(" \u2192 ");return`
              <tr>
...
${(o==null?void 0:o.message)||o}`)}}_buildModal(){var a;let t=document.createElement("div");return t.className="fh-modal-bg"+(((a=this._modal)==null?void 0:a.surface)==="drawer"?" fh-modal-bg--drawer":""),t.innerHTML=this._modalHTML(),t.addEventListener("click",o=>{o.target===t&&this._closeModal()}),t}_modalHTML(){if(!this._modal)return"";let{type:t,data:a}=this._modal,o=this._people(),s=this._attrs("sensor.family_hub_needs_attention").category_labels||[],i=this._attrs("sensor.family_hub_needs_attention").active_chores||[];switch(t){case"award":case"deduct":return As(this._modal);case"partial-credit":return Ms(this._modal);case"add-chore":return ga(null,!1,o,s,this._choreFormTab);case"edit-chore":return ga(a.chore,!0,o,s,this._choreFormTab);case"add-store-item":return Bs(o,s);case"edit-store-item":return Fs(a.item,o,s);case"add-person":return Rs();case"edit-person":return Ds(a);case"edit-settings":return Ls(a);case"ranks":return ba(this);case"claim":return Os(this._modal,o);case"add-reminder":return Ns(this._modal,o);case"confirm-remove-person":return Is(a);case"confirm-hard-delete-person":return Ts(a);case"edit-streaks":{let n=this._people().find(d=>d.person_id===a.pid),r=(n==null?void 0:n.streaks)||{};return Ps(a.pid,a.pname,i,r)}case"chip-in":return Hs(a.item,a.pid,a.balance,a.remaining);default:return""}}_closeModal(){this._modal=null,this._choreFormTab="details",this._doRender(!0)}_syncModalUI(){let t=this.shadowRoot,a=C=>{let E=t.getElementById(C);E&&(E.style.display="")},o=C=>{let E=t.getElementById(C);E&&(E.style.display="none")},s=t.getElementById("m-crec");if(s){let C=s.value,E=t.getElementById("m-ctype"),F=(E==null?void 0:E.value)||"assigned";o("m-dayfilter-section"),o("m-weekdays-section"),o("m-dom-section"),o("m-chore-expiry-section"),C==="daily"&&a("m-dayfilter-section"),C==="weekly"&&a("m-weekdays-section"),C==="monthly_on_date"&&a("m-dom-section"),F==="claimable"&&a("m-chore-expiry-section")}let i=t.getElementById("m-ctype"),n=t.getElementById("m-claimable-section"),r=t.getElementById("m-multi-claim-section"),d=t.getElementById("m-csubtype");if(i&&n){let C=i.value==="claimable";if(n.style.display=C?"":"none",r){let E=C&&(d==null?void 0:d.value)==="multi_claim";r.style.display=E?"":"none"}}let p=t.getElementById("m-cpenalty"),c=t.getElementById("m-penalty-pts-section"),b=t.getElementById("m-daily-threshold-section");p&&c&&(c.style.display=p.checked?"":"none",b&&(b.style.display=p.checked?"":"none"));let g=t.getElementById("m-sscope"),u=t.getElementById("m-sperson-section");g&&u&&(u.style.display=g.value==="personal"?"":"none");let x=t.getElementById("m-sgroup"),$=t.getElementById("m-sgroup-section");x&&$&&($.style.display=x.checked?"":"none",x.checked&&u&&(u.style.display="none"));let h=t.getElementById("m-rotation-section"),_=t.getElementById("m-rotation-config"),S=t.getElementById("m-crot-enabled"),v=t.getElementById("m-ctype");h&&(h.style.display=(v==null?void 0:v.value)==="assigned"?"":"none"),_&&S&&(_.style.display=S.checked?"":"none");let m=t.getElementById("m-crot-cadence"),w=t.getElementById("m-crot-switch-day-wrap");m&&w&&(w.style.display=m.value==="weekly"?"":"none")}}});var Qt,ho=N(()=>{K();Q();Qt=class extends HTMLElement{setConfig(t){this._cfg=t,this._render()}set hass(t){var a,o,s;this._hass=t,this._people=((s=(o=(a=t==null?void 0:t.states)==null?void 0:a["sensor.family_hub_needs_attention"])==null?void 0:o.attributes)==null?void 0:s.people)||[],this._render()}_render(){var x,$,h,_,S,v,m,w,C;let t=this._cfg||{},a=this._people||[],o=t.mode||"command_center",s=t.person||"",i=t.initial_view||"",n=t.text_scale!=null?t.text_scale:1,d=(((h=($=(x=this._hass)==null?void 0:x.states)==null?void 0:$["sensor.family_hub_needs_attention"])==null?void 0:h.attributes)||{}).rooms_config||{},p=[["","Home (default)"],...a.map(E=>[`person:${E.person_id}`,`${E.name}'s page`]),...Object.keys(d).map(E=>[`room:${E}`,`Room: ${E}`])],b=!!((S=(_=this._hass)==null?void 0:_.states)==null?void 0:S["sensor.family_hub_needs_attention"]),g=`<span style="
      ...
      </div>`,(v=this.querySelector("#e-mode"))==null||v.addEventListener("change",E=>{this._cfg={...this._cfg,mode:E.target.value},E.target.value!=="personal"&&delete this._cfg.person,E.target.value!=="command_center"&&delete this._cfg.initial_view,this._fireChange(),this._render()}),(m=this.querySelector("#e-initial-view"))==null||m.addEventListener("change",E=>{let F=E.target.value;this._cfg={...this._cfg},F?this._cfg.initial_view=F:delete this._cfg.initial_view,this._fireChange()}),(w=this.querySelector("#e-person"))==null||w.addEventListener("change",E=>{this._cfg={...this._cfg,person:E.target.value},this._fireChange()}),(C=this.querySelector("#e-scale"))==null||C.addEventListener("change",E=>{this._cfg={...this._cfg,text_scale:parseFloat(E.target.value)},this._fireChange()})}_fireChange(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._cfg},bubbles:!0,composed:!0}))}}});var Kn=go(()=>{po();ho();K();customElements.get("family-hub-card-impl")||customElements.define("family-hub-card-impl",Xt);customElements.get("family-hub-card-editor-impl")||customElements.define("family-hub-card-editor-impl",Qt);console.info(`%c FAMILY-HUB-CARD %c v${lt} %c body loaded `,"background:#7F77DD;color:#fff;font-weight:700;border-radius:4px 0 0 4px;padding:2px 6px","background:#1c1c1e;color:#fff;font-weight:400;padding:2px 6px","background:#58D38A;color:#000;font-weight:600;border-radius:0 4px 4px 0;padding:2px 6px")});export default Kn();
