...
const CSS = `
  ...
  .fh-select:disabled { opacity: 0.6; cursor: not-allowed; }
...
class FamilyHubCard extends HTMLElement {
    ...
    constructor() {
        ...
        this._eventsBound = false; // Prevents listener leak
    }
    ...
    _mEditChore(m) {
       ...
       <div class="fh-row">
         <div class="fh-field">
           <label class="fh-label">Category</label>
           <select class="fh-select" id="m-ccat" disabled>
             ${opts([
                { value: "assigned", label: "Assigned" },
                { value: "claimable", label: "Claimable" },
                { value: "maintenance", label: "Maintenance" },
